      ...
      <b-col>
        <span @click="showDatepickerFrom(prop.cName + 'From')">
          <masked-input
            ...
            v-bind:data-vv-as="cLabel2 + ' From'"
...
export default {
  ...
  created: function() {
    ...
    if (this.prop.cValidateTo == undefined || this.prop.cValidateTo == null || this.prop.cValidateTo == '') {
      this.prop.cValidateTo = 'invalidDateC'//|invalidDateRange:' + this.valueFrom + ',' + this.valueTo
    } else {
      this.prop.cValidateTo += '|invalidDateC'//|invalidDateRange:' + this.valueFrom + ',' + this.valueTo
    }
  },
