...
export default {
    data() {
        return {
            propList: {
                initialWhere: "SubPortfolioCd ='" + this.getDataUser().SubPortfolioCd + "' AND SourcePayment = 'A' AND PaymentStatus='N' AND BatchStatus='B'",                
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    ...
                    _Message_: "PaymentNo No "+ value.PaymentNo
                })
            })
