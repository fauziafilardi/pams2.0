						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputSelect2 @change="OnmodulecdChange" :prop="PI_modulecd" :value="M_SS_PageMasterFile.modulecd"/>
                                      </b-col>
                                      <b-col md="6">
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputSelect2 @change="OntablenameChange" :prop="PI_tablename" :value="M_SS_PageMasterFile.tablename"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
...
//{tablename}
        ...
        M_Insert () {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ModuleCd: this.M_SS_PageMasterFile.modulecd,
                PageCd: this.M_SS_PageMasterFile.pagecd,
                TableName: this.M_SS_PageMasterFile.tablename,
                TextMenu: this.M_SS_PageMasterFile.textmenu,
                LocationUrl: this.M_SS_PageMasterFile.locationurl,
                PageUrl: this.M_SS_PageMasterFile.pageurl,
                FilterByUserLevel: this.M_SS_PageMasterFile.filterbyuserlevel,
                UserColumnName: this.M_SS_PageMasterFile.usercolumnname,
                UserType: this.M_SS_PageMasterFile.usertype,
        ...
        M_Update () {
            var param = {			
                OptionSeq: this.getOptionSeq().OptionSeq,
                LineNo: this.$parent.data.PageOrder,
                PageMasterSeq: this.M_SS_PageMasterFile.pagemasterseq,
                ModuleCd: this.M_SS_PageMasterFile.modulecd,
                PageCd: this.M_SS_PageMasterFile.pagecd,
                TableName: this.M_SS_PageMasterFile.tablename,
                TextMenu: this.M_SS_PageMasterFile.textmenu,
...
,                pagemasterseq: record.PageMasterSeq,
            ...
            .then(response => {
                ...
                this.M_SS_PageMasterFile = {
                    ...
                    modulecd: record.ModuleCd,
                    // modulecdLabel: {id: data.modulecd, label: data.modulecd + " | " + data.moduledescs},
                    pagecd: data.pagecd,
                    textmenu: data.textmenu,
                    locationurl: data.locationurl,
                    pageurl: data.pageurl,
                    imageurld: data.imageurld,
                    pagetype: data.pagetype,
                    usetable: data.usetable,
                    usefield: data.usefield,
                    useamountfield: data.useamountfield,
                    filterbyuserlevel: data.filterbyuserlevel,
