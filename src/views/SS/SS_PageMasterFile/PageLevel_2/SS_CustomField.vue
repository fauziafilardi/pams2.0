						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                ...
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputSelect2 @change="OnlookuptableChange" :prop="PI_lookuptable" :value="M_SS_CustomField.lookuptable"/>
                                      </b-col>
                                      <b-col md="6">
                                          <div>
    ...
    methods: {
        ...
        OnlookuptableChange (data) {
            this.$nextTick(() => {
                ...
                .then(response => { 
                    ...
                    this.AvailableColumn = response.map(x=>x.name)
        ...
        M_Insert () {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                PageMasterSeq: this.M_SS_CustomField.pagemasterseq,
                Caption: this.M_SS_CustomField.caption,
                DataType: this.M_SS_CustomField.datatype,
                Length: this.M_SS_CustomField.length,
                Mandatory: this.M_SS_CustomField.mandatory,
                LookupStatus: this.M_SS_CustomField.lookupstatus,
                LookupTable: this.M_SS_CustomField.lookuptable,
                LookupField: this.M_SS_CustomField.lookupfield,
                LookupCondition: this.M_SS_CustomField.lookupcondition,
                DefaultDescs: this.M_SS_CustomField.defaultdescs,
                DefaultNumeric: this.M_SS_CustomField.defaultnumeric == '' ? 'NULL' : this.M_SS_CustomField.defaultnumeric,
                DefaultDate: this.M_SS_CustomField.defaultdate == '' ? 'NULL' : this.M_SS_CustomField.defaultdate,
        ...
        M_Update () {
            ...
            var param = {			
                OptionSeq: this.getOptionSeq().OptionSeq,
                LineNo: this.$parent.data.PageOrder,
                FieldSequenceNo: this.M_SS_CustomField.fieldsequenceno,
                PageMasterSeq: this.M_SS_CustomField.pagemasterseq,
                Caption: this.M_SS_CustomField.caption,
                DataType: this.M_SS_CustomField.datatype,
                Length: this.M_SS_CustomField.length,   
                ...
                LookupCondition: this.M_SS_CustomField.lookupcondition,
                DefaultDescs: this.M_SS_CustomField.defaultdescs,
                DefaultNumeric: this.M_SS_CustomField.defaultnumeric == null ? 'NULL' : this.M_SS_CustomField.defaultnumeric,
                DefaultDate: this.M_SS_CustomField.defaultdate == null ? 'NULL' : this.M_SS_CustomField.defaultdate,
                Remarks: this.M_SS_CustomField.remarks,
                UserEdit: this.getDataUser().UserId ,
