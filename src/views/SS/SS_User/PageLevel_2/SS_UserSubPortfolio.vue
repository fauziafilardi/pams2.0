...
//{descs}
		...
		paramFromParent(){
            ...
            this.M_SS_UserSubPortfolio.userid = data.UserId 
        ...
        M_Insert() {
            var param = {			
                ...
                SubPortfolioCd: this.M_SS_UserSubPortfolio.subportfoliocd,
                Status: this.M_SS_UserSubPortfolio.status,
                DefaultLoginStatus: this.M_SS_UserSubPortfolio.defaultloginstatus === true ? "Y" : "N",
...
this.M_SS_UserSubPortfolio = {
                ...
                name: data.name,
                status: data.status,
                defaultloginstatus: data.defaultloginstatus == "Y" ? true : "",
                descs: data.descs,
                ...
                rowid: data.rowid
                    ...
                    this.M_SS_UserSubPortfolio.subportfoliocdLabel = this.M_SS_UserSubPortfolio.subportfoliocd && this.M_SS_UserSubPortfolio.subportfoliocd != '' ? data.subportfoliocd + this.separator + data.name : ''
