...
export default {
    ...
    methods: {
        ...
        M_Save(){
            ...
            this.M_SS_PageMaster.LineNo = this.$parent.data.PageOrder

            if(this.$store.getters.getStatus.toUpperCase() !== 'NEW'){
                this.M_SS_PageMaster.UserEdit = this.getDataUser().UserId
                ...
                this.M_SS_PageMaster.UserInput = this.getDataUser().UserId
                // alert('save api')
    ...
    mounted: function() {
        ...
        if(this.getDataUser().UserType == 'I'){
