...
export default {
    ...
    methods: {
        ...
        M_Post(dt){
            var param = {
                FromGroupCd: this.M_UserGroupDashboard.FromGroupCd,
                FromSubPortfolioCd: this.M_UserGroupDashboard.FromSubPortfolioCd,
                ToGroupCd: this.M_UserGroupDashboard.ToGroupCd,
                ToSubPortfolioCd: this.M_UserGroupDashboard.ToSubPortfolioCd,
        ...
        paramFromParent(){
            ...
            this.M_UserGroupDashboard.UserGroup = data.UserGroup
        },
