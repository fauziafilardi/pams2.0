...
export default {
    ...
    return {
      ...
      PI_FromDebitNo: {
        dataLookUp: {
          ...
          ColumnDB: 'DebitNo',
          InitialWhere: "Status = 'P' AND JournalCategory = 'D' AND SUBPORTFOLIOCD='" + this.getDataUser().SubPortfolioCd + "'",
          ParamWhere: ''
        },
        cValidate :'',
        cName:'FromDebitNo',
      ...
      PI_TrxTypeFrom: {
        dataLookUp: {
          ...
          ColumnDB: 'TrxType',
          InitialWhere: "ModuleCd = 'AR' AND TrxClass IN ('I','D') AND SUBPORTFOLIOCD='" + this.getDataUser().SubPortfolioCd + "'",
          ParamWhere: ''
        },
        cValidate :'',
        cName:'TrxTypeFrom',
      ...
      PI_FromCashierNo: {
        dataLookUp: {
          ...
          ColumnDB: 'CashierNo',
          InitialWhere: "PaymentAllocationStatus='T' And DebtorCd IS NOT NULL And PaymentCategory='I' And LedgerHStatus='Y' AND SUBPORTFOLIOCD='" + this.getDataUser().SubPortfolioCd + "'",
          ParamWhere: ''
        },
        cValidate :'',
        cName:'FromCashierNo',
      ...
      PI_FromCreditNo: {
        dataLookUp: {
          ...
          ColumnDB: 'CreditNo',
          InitialWhere: "Source In ('L','R','E','Z') AND SUBPORTFOLIOCD='" + this.getDataUser().SubPortfolioCd + "'",
          ParamWhere: ''
        },
        cValidate :'',
        cName:'FromCreditNo',
  ...
  methods: {
    ...
    OnDebitNoToChange (data) {
      this.InvoiceAllocationDirect.ToDebitNo = data.id
      this.InvoiceAllocationDirect.ToDebitNoLabel = data.label
      this.PI_FromDebtorCd.dataLookUp.InitialWhere = "Status = 'Y' AND SUBPORTFOLIOCD='" + this.getDataUser().SubPortfolioCd + "' AND ( DebtorCd Between '"+this.debtorawal+"' AND '"+data.DebtorCd+"' )"
    },
    ...
    M_GenerateReport () {
      ...
      params += "SubportfolioCd:" + this.getDataUser().SubPortfolioCd + "^"
      params += "DateFormat:dd-MMM-yyyy^"
      params += "FormatNumber:###,##0.00^"
      params += "UserName:" + this.getDataUser().Username + "^"
      params += "LogoUrl:^"
