...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ContactId: this.M_CM_Insurance.contactid == '' || this.M_CM_Insurance.contactid == null ? 'NULL' : this.M_CM_Insurance.contactid ,
                ReferenceNo: this.M_CM_Insurance.referenceno,
                StartDate: this.M_CM_Insurance.startdate,
                ReasonCd: this.M_CM_Insurance.reasoncd == '' || this.M_CM_Insurance.reasoncd == null ? 'NULL' : this.M_CM_Insurance.reasoncd ,
                ReasonDescs: this.M_CM_Insurance.reasondescs,
...
this.M_CM_Insurance = {
                ...
                this.M_CM_Insurance.contactidLabel = this.M_CM_Insurance.contactid != null ? data.contactid + this.separator + data.contactname :'' 
                this.M_CM_Insurance.reasoncdLabel = this.M_CM_Insurance.reasoncd != null ? data.reasoncd + this.separator + data.cmreasondescs :'' 
