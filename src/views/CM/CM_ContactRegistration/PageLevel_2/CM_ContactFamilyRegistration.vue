						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputSelect2 @change="OnrelationChange" :prop="PI_relation" :value="M_CM_ContactFamilyRegistration.relation" :label="M_CM_ContactFamilyRegistration.relationLabel" ref="ref_relation"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
...
//{birthdate}
        ...
        OngenderChange (data) {
            this.M_CM_ContactFamilyRegistration.gender = data
        this.$nextTick(() => {
            if (this.inputStatus != "VIEW") {
//{gender}
            }
...
//{remarks}
		...
		paramFromParent(){
            ...
            // this.M_CM_ContactFamilyRegistration.contactid = data.SequenceRegistrationNo 
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ContactId: this.M_CM_ContactFamilyRegistration.contactid,
        ...
        M_New(){
            let data = this.$store.getters.GetPage1Data
            this.M_CM_ContactFamilyRegistration.contactid = data.ContactId
...
this.M_CM_ContactFamilyRegistration = {
                ...
                this.M_CM_ContactFamilyRegistration.salutationcdLabel = this.M_CM_ContactFamilyRegistration.salutationcd != null ? data.salutationcd + this.separator + data.salutationdescs :'' 
                this.M_CM_ContactFamilyRegistration.nationalitycdLabel = this.M_CM_ContactFamilyRegistration.nationalitycd != null ? data.nationalitycd + this.separator + data.nationalitydescs :'' 
                this.M_CM_ContactFamilyRegistration.religioncdLabel = this.M_CM_ContactFamilyRegistration.religioncd != null ? data.religioncd + this.separator + data.religiondescs :'' 
        ...
        ,getFileName(fileName) {
         this.M_CM_ContactFamilyRegistration.picturefilename = fileName 
        }
