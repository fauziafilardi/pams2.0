...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_AR_Debtor_OneBill_Document.contactid = data.ContactId 
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ContactID: this.M_AR_Debtor_OneBill_Document.contactid,
                DocumentType: this.M_AR_Debtor_OneBill_Document.documenttype == '' || this.M_AR_Debtor_OneBill_Document.documenttype == null ? 'NULL' : this.M_AR_Debtor_OneBill_Document.documenttype ,
                Descs: this.M_AR_Debtor_OneBill_Document.descs,
                DocumentFileName: this.M_AR_Debtor_OneBill_Document.documentfilename,
        ...
        M_Update() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ContactID: this.M_AR_Debtor_OneBill_Document.contactid,
                SequenceNo: this.M_AR_Debtor_OneBill_Document.sequenceno,
                DocumentType: this.M_AR_Debtor_OneBill_Document.documenttype == '' || this.M_AR_Debtor_OneBill_Document.documenttype == null ? 'NULL' : this.M_AR_Debtor_OneBill_Document.documenttype ,
                Descs: this.M_AR_Debtor_OneBill_Document.descs,
                DocumentFileName: this.M_AR_Debtor_OneBill_Document.documentfilename,
                Remarks: this.M_AR_Debtor_OneBill_Document.remarks,
                UserEdit: this.getDataUser().UserId ,
                LastUpdateStamp: this.M_AR_Debtor_OneBill_Document.lastupdatestamp                
            }
...
this.M_AR_Debtor_OneBill_Document = {
                ...
                this.M_AR_Debtor_OneBill_Document.documenttypeLabel = this.M_AR_Debtor_OneBill_Document.documenttype != null ? data.documenttype + this.separator + data.descs :'' 
