						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSinputTextVuex :prop="PI_countrycd" v-model="M_CM_CountryCity.countrycd"  ref="ref_countrycd"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
...
export default {
    ...
    data() {
        return {
		cInsertKey:'id=CountryCd,label=CountryCd+|+Descs',
		FormType: "List",
		Module:"CM",
            propList: {
                initialWhere: "",
    ...
    methods: {		
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                CountryCd: this.M_CM_CountryCity.countrycd,
