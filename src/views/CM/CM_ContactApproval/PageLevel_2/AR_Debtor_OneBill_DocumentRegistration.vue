...
this.M_AR_Debtor_OneBill_DocumentRegistration = {
                ...
                this.M_AR_Debtor_OneBill_DocumentRegistration.documenttypeLabel = this.M_AR_Debtor_OneBill_DocumentRegistration.documenttype != null ? data.documenttype + this.separator  :'' 
