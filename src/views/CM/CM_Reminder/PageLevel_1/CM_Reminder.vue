						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputDateTime @input="OnreminderdateChange" :prop="PI_reminderdate" v-model="M_CM_Reminder.reminderdate"  ref="ref_reminderdate" />
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
...
export default {
    ...
    return {
		...
		FormType: "List",
        Module:"CM",
        Valkey:this.getDataUser().UserId,
        
            propList: {
                
                initialWhere: "Status = 'Y' AND UserInput='"+this.getDataUser().UserId+"'",
...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                ReminderDate: this.M_CM_Reminder.reminderdate == '' || this.M_CM_Reminder.reminderdate == null ? 'NULL' : this.M_CM_Reminder.reminderdate ,
        ...
        M_Update() {
            var param = {			
                OptionSeq: this.getOptionSeq().OptionSeq,
                LineNo: this.$parent.data.PageOrder,
                SequenceNo: this.M_CM_Reminder.sequenceno,
                Descs: this.M_CM_Reminder.descs,
                ReminderDate: this.M_CM_Reminder.reminderdate == '' || this.M_CM_Reminder.reminderdate == null ? 'NULL' : this.M_CM_Reminder.reminderdate ,
                Remarks: this.M_CM_Reminder.remarks,
                UserEdit: this.getDataUser().UserId ,
