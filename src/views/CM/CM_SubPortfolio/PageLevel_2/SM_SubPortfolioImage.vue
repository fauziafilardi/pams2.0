                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSFileUpload :prop="PI_referencefilename" @fileName="getFileName" 
                                                                        v-model="M_SM_SubPortfolioImage.referencefilename" 
                                                                        :file="M_SM_SubPortfolioImage.picturefilename" 
                                                                        :image="M_SM_SubPortfolioImage.referencefilename"
...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_SM_SubPortfolioImage.subportfoliocd = data.SubPortfolioCd 
        ...
        M_Insert() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                SubPortfolioCD: this.M_SM_SubPortfolioImage.subportfoliocd,
                Descs: this.M_SM_SubPortfolioImage.descs,
                PictureFileName: this.M_SM_SubPortfolioImage.picturefilename,
                ReferenceFileName: this.M_SM_SubPortfolioImage.referencefilename,
        ...
        M_Update() {
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                SubPortfolioCD: this.M_SM_SubPortfolioImage.subportfoliocd,
                SequenceNo: this.M_SM_SubPortfolioImage.sequenceno,
                Descs: this.M_SM_SubPortfolioImage.descs,
                PictureFileName: this.M_SM_SubPortfolioImage.picturefilename,
                ReferenceFileName: this.M_SM_SubPortfolioImage.referencefilename,
                Remarks: this.M_SM_SubPortfolioImage.remarks,
...
this.M_SM_SubPortfolioImage = {
        ...
        ,getFileName(fileName) {
         this.M_SM_SubPortfolioImage.picturefilename = fileName 
        }
