                ...
                <b-col md="12" id="col-left">
                  ...
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_addresscd"
                        v-model="M_CM_ContactAddress.addresscd"
                        ref="ref_addresscd"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_idno"
                        v-model="M_CM_ContactAddress.idno"
                        ref="ref_idno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputCheckBox
                        @input="OnaddresscategoryChange"
                        :prop="PI_addresscategory"
                        v-model="M_CM_ContactAddress.addresscategory"
                        ref="ref_addresscategory"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_passportno"
                        v-model="M_CM_ContactAddress.passportno"
                        ref="ref_passportno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        ...
                        :prop="PI_addresstype"
                        v-model="M_CM_ContactAddress.addresstype"
                        ref="ref_addresstype"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        ...
                        :value="M_CM_ContactAddress.salutationcd"
                        :label="M_CM_ContactAddress.salutationcdLabel"
                  ...
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_attention"
                        v-model="M_CM_ContactAddress.attention"
                        ref="ref_attention"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_address1"
                        v-model="M_CM_ContactAddress.address1"
                        ref="ref_address1"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_address2"
                        v-model="M_CM_ContactAddress.address2"
                        ref="ref_address2"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_address3"
                        v-model="M_CM_ContactAddress.address3"
                        ref="ref_address3"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_address4"
                        v-model="M_CM_ContactAddress.address4"
                        ref="ref_address4"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_zipcode"
                        v-model="M_CM_ContactAddress.zipcode"
                        ref="ref_zipcode"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        ...
                        :prop="PI_citycd"
                        :value="M_CM_ContactAddress.citycd"
                        :label="M_CM_ContactAddress.citycdLabel"
                        ref="ref_citycd"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_phoneno"
                        v-model="M_CM_ContactAddress.phoneno"
                        ref="ref_phoneno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_faxno"
                        v-model="M_CM_ContactAddress.faxno"
                        ref="ref_faxno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_email"
                        v-model="M_CM_ContactAddress.email"
                        ref="ref_email"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSTextAreaVuex
                        ...
                        :prop="PI_remarks"
                        v-model="M_CM_ContactAddress.remarks"
                        ref="ref_remarks"
                      />
                    </b-col>
                  </b-row>
  ...
  methods: {
    ...
    M_Insert() {
      var param = {
        ...
        BillingStatus:
          this.M_CM_ContactAddress.addresscategory.indexOf("B") >= 0
            ? "Y"
            : "N",
        MailingStatus:
          this.M_CM_ContactAddress.addresscategory.indexOf("M") >= 0
            ? "Y"
            : "N",
        TaxStatus:
          this.M_CM_ContactAddress.addresscategory.indexOf("T") >= 0
            ? "Y"
            : "N",
        AddressType: this.M_CM_ContactAddress.addresstype,
        SalutationCd:
          this.M_CM_ContactAddress.salutationcd == "" ||
          this.M_CM_ContactAddress.salutationcd == null
            ? "NULL"
            : this.M_CM_ContactAddress.salutationcd,
        ...
        CityCd:
          this.M_CM_ContactAddress.citycd == "" ||
          this.M_CM_ContactAddress.citycd == null
            ? "NULL"
            : this.M_CM_ContactAddress.citycd,
    ...
    getDataBy(record) {
      ...
      this.postEncode(this.getUrlById(), param).then(response => {
        ...
        this.M_CM_ContactAddress.salutationcdLabel =
          this.M_CM_ContactAddress.salutationcd != null
            ? data.salutationcd + this.separator + data.salutationdescs
            : "";
        this.M_CM_ContactAddress.citycdLabel =
          this.M_CM_ContactAddress.citycd != null
