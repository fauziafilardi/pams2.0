              ...
              <b-row style="padding-left:10px;">
                <b-col md="12" id="col-left">
                  ...
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        @change="OnbusinesstypecdChange"
                        :prop="PI_businesstypecd"
                        :value="M_CM_ContactBusinessType.businesstypecd"
                        :label="M_CM_ContactBusinessType.businesstypecdLabel"
                        ref="ref_businesstypecd"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        @input="OncorebusinessChange"
                        :prop="PI_corebusiness"
                        v-model="M_CM_ContactBusinessType.corebusiness"
                        ref="ref_corebusiness"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        ...
                        v-model="M_CM_ContactBusinessType.businessname"
                  ...
                  <b-row>
                    <b-col md="6">
                      <ABSTextAreaVuex
                        ...
                        :prop="PI_remarks"
                        v-model="M_CM_ContactBusinessType.remarks"
                        ref="ref_remarks"
                      />
                    </b-col>
                  </b-row>
  ...
  methods: {
    ...
    M_Insert() {
      var param = {
        ...
        BusinessType:
          this.M_CM_ContactBusinessType.businesstypecd == "" ||
          this.M_CM_ContactBusinessType.businesstypecd == null
            ? "NULL"
            : this.M_CM_ContactBusinessType.businesstypecd,
    ...
    getDataBy(record) {
      ...
      this.postEncode(this.getUrlById(), param).then(response => {
        ...
        this.M_CM_ContactBusinessType.businesstypecdLabel =
          this.M_CM_ContactBusinessType.businesstypecd != null
            ? data.businesstypecd + this.separator + data.businesstypedescs
            : "";
