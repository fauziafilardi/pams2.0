...
export default {
    ...
    methods: {
		...
		setToolbarButton () {
            ...
            this.toToolbar().statusFunction[2].disabled = false
		},
        M_Head_Table () {
        },
        M_PageSize(){
        ...
        M_Post(){
            ...
            this.postJSON(this.getUrlGenerateReport(), param).then(response => {
                ...
                localStorage.reportGenerator = JSON.stringify(data)
        ...
        M_Delete(dt){       
            ...
            dataDelete.push({
                ...
                _Message_: ""//"Queue Sequence No:"+value.SequenceNo+", have been removed.."
                    })
            })
