                            ...
                            <b-row style="padding-left:10px;">					
                                ...
                                <b-col md="12" id="col-left">                                    
                                    ...
                                    <b-row style="padding-top:10px; padding-right: 10px; padding-left: 20px; padding-bottom: 10px; !important;">                                        
                                      <b-col md="4">
                                        Available Transaction Analysis Code
                                        <ABSMultiSelect
                                            v-model="leftData"
                                      ...
                                      <b-col md="4">
                                        Assigned Transaction Analysis Code
                                        <ABSMultiSelect
                                            v-model="rightData"
...
export default {
    ...
    data() {
        return {
            ...
            M_GL_AnalysisCategoryDetailAssignToSubportfolio :{
    ...
    methods: {
        ...
        getDataList (search) {
            ...
            var param = {
                ...
                TrxAnalysisCategory: this.DataRowPage1.TrxAnalysisCategory,
                LineNo: 2,
                InitialWhere: "TrxAnalysisCd like '%" + search + "%'",
                ParamView: "'"+this.DataRowPage1.TrxAnalysisCategory+"'" ,
                SortField: 'TrxAnalysisCd'
            ...
            .then( response => {
                ...
                for (var x = 0; x < this.allDataOptions.length; x++) {
                    ...
                    for (var y = 0; y < this.rightDataOptions.length; y++) {
                        if (this.allDataOptions[x].TrxAnalysisCd == this.rightDataOptions[y].value) {  
                            status = true
                            break
                        }
                    }
                    if (status == false) {
                        this.leftDataOptions.push({
                            value: this.allDataOptions[x].TrxAnalysisCd,                             
                            key: this.allDataOptions[x].TrxAnalysisCd
                            // ,
            ...
            .then( response => {
                ...
                for (var x = 0; x < data.length; x++) {
                    this.rightDataOptions.push({
                        value: data[x].trxanalysiscd,                        
                        key: data[x].trxanalysiscd,
                        RowId: data[x].trxanalysiscd,
                    })
                }
        ...
        M_Insert() {
            ...
            for (let x = 0 ; x < this.leftDataOptions.length ; x ++) {
                param1.push({
                    ...
                    SubportfolioCd: this.getDataUser().SubPortfolioCd,
                    TrxAnalysisCategory: this.DataRow.TrxAnalysisCategory,
                    TrxAnalysisCd: this.leftDataOptions[x].value
                })
            }
            ...
            for (let x = 0 ; x < this.rightDataOptions.length ; x ++) {
                param2.push({
                    ...
                    SubportfolioCd: this.getDataUser().SubPortfolioCd,
                    TrxAnalysisCategory: this.DataRow.TrxAnalysisCategory,
                    TrxAnalysisCd: this.rightDataOptions[x].value,
		...
		M_ClearForm(){
            this.M_GL_AnalysisCategoryDetailAssignToSubportfolio = {
                sequenceregistrationno: '',
                addresscd: '',
                billingstatus: '',
                mailingstatus: '',
