...
export default {
    data() {
        return {
            propList: {
                initialWhere: "CustomerType = 'L' AND [Status] = 'N' AND SubPortfolioCd='"+this.getDataUser().SubPortfolioCd+"' AND (UserId IS NULL OR (UserId='"+this.getDataUser().UserId+"' AND LOOStatus = 'Y'))",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    ...
                    // OutputMessage_Output : value.ApplicationNo,
