    ...
    data() {
        return {
            propList: {
                ...
                // AND Not Exists (Select 1 From TN_Contract Where TN_Contract.Status IN ('N','A') AND TN_Contract.EventNo IS NOT NULL AND TN_Contract.EventNo=VW_TN_Event.EventNo) 
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    ...
                    _Message_:"Event No : '"+ value.EventNo +"'"
                })
            })
