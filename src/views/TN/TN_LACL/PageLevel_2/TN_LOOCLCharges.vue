						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSInputSelectList @change="OnchargetypeChange" :prop="PI_chargetype" :value="M_TN_LOOCharges.chargetype" :label="M_TN_LOOCharges.chargetypeLabel" ref="ref_chargetype"/>
                                      </b-col>
                                      <b-col md="6">
...
export default {
    ...
    data() {
        return {
            ...
            PI_chargetype: { 
                ...
                cOption: [], 
                cMasterUrl: '' ,
                cDisplayColumn: 'ChargeType,ChargeTypeDescs' ,
            }, 
            PI_billingday: { 
                cValidate :'required', 
                cName: 'billingday', 
    ...
    methods: {
        ...
        this.$nextTick(() => {
            ...
            this.M_TN_LOOCharges.chargetype = data.TenancyChargeType
            this.M_TN_LOOCharges.chargetypeLabel = data.TenancyChargeType +'|'+data.TenancyChargeTypeDescription
...
this.M_TN_LOOCharges = {
                ...
                this.M_TN_LOOCharges.chargetypeLabel = this.M_TN_LOOCharges.chargetype != null && this.M_TN_LOOCharges.chargetype != '' ? data.chargetype + this.separator + data.chargetypedesc :'' 
