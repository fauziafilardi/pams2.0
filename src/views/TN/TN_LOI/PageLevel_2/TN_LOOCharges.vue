						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                ...
                                <b-col md="6" id="col-right">
                                  ...
                                  <b-row>
                                    <b-col md="12">
                                      <ABSinputTextVuex :prop="PI_billingrate" v-model="M_TN_LOOCharges.billingrate"  ref="ref_billingrate"/>
                                    </b-col>
                                  </b-row>
                                  <b-row>
                                    <b-col md="12">
    ...
    data() {
        return {
            ...
            PI_addresscd: { 
                ...
                cStatic: false, 
                cOption: [], 
                cMasterUrl: 'CM/CM_Address?oid=E7AC288B0F2D41445904D071BA37AAFF&ContactId=' ,
    ...
    methods: {
      SetOptionControlStateByChargeType(){
        ...
        switch(this.M_TN_LOOCharges.chargetype){
          case "A":
              this.PI_installmentmethod.cProtect = true
        ...
        if(this.M_TN_LOOCharges.installmentmethod=='N'){
            ...
            switch(this.M_TN_LOOCharges.chargebasis){
              case "C":
                  ...
                  this.PI_billingpercent.cAllowMinus = false
        ...
        M_New(){
          // this.$nextTick(() => {
            ...
            if (this.ContractData.ChargeArea == "G") {
              this.M_TN_LOOCharges.totalarea = this.ContractData.TotalGrossArea
            } else if (this.ContractData.ChargeArea == "S") {
              this.M_TN_LOOCharges.totalarea = this.ContractData.TotalSemiGrossArea
            } else if (this.ContractData.ChargeArea == "N") {
              this.M_TN_LOOCharges.totalarea = this.ContractData.TotalNetArea
            }
          // })
          // this.$forceUpdate()
...
this.M_TN_LOOCharges = {
                ...
                billingdueday: this.isCurrency(data.billingdueday, this.decimal),
                billingduemonth: this.isCurrency(data.billingduemonth, this.decimal),
