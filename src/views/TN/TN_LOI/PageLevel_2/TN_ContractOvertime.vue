						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSinputRadioButtonVuex @input="OnchargetypeChange" :prop="PI_chargetype" v-model="M_TN_ContractOvertime.chargetype"  ref="ref_chargetype" />
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
            ...
            var param = {
                  ...
                  .then(ress => {
                    ...
                    if (ress.length > 0) {
                      ...
                      if(data.ChargeType !=''){
                          this.M_TN_ContractOvertime.chargetype = data.ChargeType
                      }
...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                ChargeType: this.M_TN_ContractOvertime.chargetype,
...
this.M_TN_ContractOvertime = {
                ...
                this.M_TN_ContractOvertime.overtimecdLabel = this.M_TN_ContractOvertime.overtimecd != null && this.M_TN_ContractOvertime.overtimecd != '' ? data.overtimecd + this.separator  :'' 
                this.M_TN_ContractOvertime.lotnoLabel = this.M_TN_ContractOvertime.lotno != null && this.M_TN_ContractOvertime.lotno != '' ? data.lotno + this.separator  :'' 
                this.M_TN_ContractOvertime.currencycdLabel = this.M_TN_ContractOvertime.currencycd != null && this.M_TN_ContractOvertime.currencycd != '' ? data.currencycd + this.separator  :'' 
                this.M_TN_ContractOvertime.credittermscdLabel = this.M_TN_ContractOvertime.credittermscd != null && this.M_TN_ContractOvertime.credittermscd != '' ? data.credittermscd + this.separator  :'' 
