                ...
                <b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                  <b-row style="padding-left:10px;">					
                    <b-col md="12" id="col-left"> <!-- table open -->
                      <b-row>
                        <b-col  md="6">
                          <ABSCompute :prop="PI_lotno" v-model="M_TN_LOOLotRental.lotno" ref="ref_lotno" />
                        </b-col>
                      </b-row>
                      <b-row>
                        <b-col  md="6">
                          <ABSCompute :prop="PI_Gross_SemiGross_NetArea" v-model="M_TN_LOOLotRental.Gross_SemiGross_NetArea" ref="ref_Gross_SemiGross_NetArea" />
                        </b-col>
                      </b-row>
                      <b-row>
                        <b-col  md="6">
                          <ABSCompute :prop="PI_BlockCd" v-model="M_TN_LOOLotRental.blockcd" ref="ref_Block" />
                        </b-col>
                      </b-row>
                      <b-row>
                        <b-col  md="6">
                          <ABSCompute :prop="PI_FloorCd" v-model="M_TN_LOOLotRental.floorcd" ref="ref_Floor" />
                        </b-col>
                      </b-row>
                    </b-col>
                  </b-row>
    ...
    data() {
        return {
          ...
          FormType: "List",
			    Module:"TN",
            propList: {
                initialWhere:"ApplicationNo = '" + this.ValKey + "' AND SubPortfolioCd ='"+this.getDataUser().SubPortfolioCd+"'",
        ...
        M_Update () {
          ...
          for (let x = 0 ; x < this.dataDetail.length ; x ++) {
            param1.push({
              ...
              ChangesLot: this.M_TN_LOOLotRental.lotno
            })
            onLoop++
          }
          ...
          var param3 = {
            ...
            LotNo: this.M_TN_LOOLotRental.lotno
          }
