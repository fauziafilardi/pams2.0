<template>
    <div class="height--full">
        ...
        <!-- <div class="content-app-form__body" style="background-color: white;padding-top: 1px !important;margin-left: 15px;margin-right: 15px;height: 95%;overflow-y: auto;overflow-x: hidden;padding-bottom: 80px;"> -->
            <div class="content-app-form__body form-process"><!--  untuk munculin gear -->
            <ABSListVuex
                :prop = "propList"
                :title = "''"
                :isProcess = "true"
...
export default {
    data() {
        return {
            propList: {
                initialWhere: "[Status] NOT IN ('X','C') AND SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "'",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
    ...
    methods: {
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    _Message_: "Lease progress for Application No  = "+value.LOONo,
