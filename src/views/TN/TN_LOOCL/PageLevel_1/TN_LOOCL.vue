              ...
              <b-row style="padding-left:10px;">
                <b-col md="6" id="col-left">
                  <b-row>
                    <b-col md="12">
                      <ABSinputTextVuex
                        ...
                        v-model="M_TN_LOOCL.applicationno"
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        @change="OncopyfromapplicationnoChange"
                        :prop="PI_copyfromapplicationno"
                        :value="M_TN_LOOCL.copyfromapplicationno"
                        :label="M_TN_LOOCL.copyfromapplicationnoLabel"
                        ref="ref_copyfromapplicationno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        ...
                        :prop="PI_contactid"
                        :value="M_TN_LOOCL.contactid"
                        :label="M_TN_LOOCL.contactidLabel"
                        ref="ref_contactid"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        @change="OneventnoChange"
                        :prop="PI_eventno"
                        :value="M_TN_LOOCL.eventno"
                        :label="M_TN_LOOCL.eventnoLabel"
                        ref="ref_eventno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        @change="OncustomercategorycdChange"
                        :prop="PI_customercategorycd"
                        :value="M_TN_LOOCL.customercategorycd"
                        :label="M_TN_LOOCL.customercategorycdLabel"
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSCompute
                        :prop="PI_customersource"
                        v-model="M_TN_LOOCL.customersource"
                        ref="ref_customersource"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      <ABSinputTextVuex
                        :prop="PI_referenceno"
                        v-model="M_TN_LOOCL.referenceno"
                        ref="ref_referenceno"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        ...
                        :prop="PI_brandcd"
                        :value="M_TN_LOOCL.brandcd"
                        :label="M_TN_LOOCL.brandcdLabel"
                        ref="ref_brandcd"
                      />
                    </b-col>
                  </b-row>
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        @change="OnmarketingidChange"
                        :prop="PI_marketingid"
                        :value="M_TN_LOOCL.marketingid"
                        :label="M_TN_LOOCL.marketingidLabel"
                        ref="ref_marketingid"
                      />
                    </b-col>
                  </b-row>
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSInputTimeRange
                        ...
                        :valueFrom="M_TN_LOOCL.operatingfromhour"
                        :valueTo="M_TN_LOOCL.operatingtohour"
                ...
                <b-col md="6" id="col-left">
                      ...
                      <b-row>
                        ...
                        <b-col md="1" style="margin-left: 10px;">
                          <ABSTextBoxOnly
                            ...
                            :prop="PI_leaseperiod"
                            v-model="M_TN_LOOCL.leaseperiod"
                            ref="ref_leaseperiod"
                          />
                        </b-col>

                        <b-col md="4">{{M_TN_LOOCL.chargeperiod}}</b-col>
                      </b-row>
                    </b-col>
                  </b-row>
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSinputDateRangeVuex
                        :prop="PI_rcd"
                        :valueFrom="M_TN_LOOCL.rcd"
                        :valueTo="M_TN_LOOCL.red"
                        ref="ref_rcd"
                        @from="MdtRange_rcd"
                        @to="MdtRange_red"
                      />
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSinputDateRangeVuex
                        ...
                        :valueFrom="M_TN_LOOCL.utilitiesstartdate"
                        :valueTo="M_TN_LOOCL.utilitiesenddate"
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSInputSelectList
                        ...
                        :prop="PI_currencycd"
                        :value="M_TN_LOOCL.currencycd"
                        :label="M_TN_LOOCL.currencycdLabel"
                        ref="ref_currencycd"
                      />
                    </b-col>
                  </b-row>
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSCompute
                        :prop="PI_totalrental"
                        v-model="M_TN_LOOCL.totalrental"
                        ref="ref_totalrental"
                      />
                    </b-col>
                  </b-row>
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSCompute
                        ...
                        v-model="M_TN_LOOCL.totalarealot"
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSinputTextVuex
                        ...
                        v-model="M_TN_LOOCL.telephoneline"
                  ...
                  <b-row>
                    <b-col md="12">
                      <ABSinputTextVuex
                        ...
                        v-model="M_TN_LOOCL.telephonedeposit"
...
export default {
  ...
  data() {
    return {
      ...
      propList: {
        initialWhere:
          "CustomerType = 'C' AND ContractStatus IN ('1','3','4') AND SubPortfolioCd = '" +
      ...
      PI_brandcd: {
        dataLookUp: {
          ...
          ColumnDB: "BrandCd",
          InitialWhere:
            "ISNULL(CLStatus,'')='Y' AND (BrandOwnerId = '' OR  ISNULL(BrandOwnerId,'')='')",
          ParamWhere: ""
        },
        cValidate: "",
        cName: "brandcd",
  ...
  methods: {
    GetEventData() {
      ...
      this.FnDynamicFunction(param).then(ress => {
        ...
        this.M_TN_LOOCL.customercategorycdLabel =
          this.M_TN_LOOCL.customercategorycd != null &&
        ...
        this.M_TN_LOOCL.brandcdLabel =
          this.M_TN_LOOCL.brandcd != null && this.M_TN_LOOCL.brandcd != ""
            ? data.BrandCd + this.separator + data.BrandDescs
            : "";
    ...
    GetContract() {
      ...
      this.FnDynamicFunction(param).then(ress => {
        ...
        this.M_TN_LOOCL.contactidLabel =
          this.M_TN_LOOCL.contactid != null && this.M_TN_LOOCL.contactid != ""
        ...
        this.M_TN_LOOCL.currencycdLabel =
          this.M_TN_LOOCL.currencycd != null && this.M_TN_LOOCL.currencycd != ""
            ? data.CurrencyCd + this.separator
            : "";
        this.M_TN_LOOCL.marketingid = data.MarketingID;
        this.M_TN_LOOCL.marketingidLabel =
          this.M_TN_LOOCL.marketingid != null &&
          this.M_TN_LOOCL.marketingid != ""
            ? data.MarketingID + this.separator + data.MarketingName
            : "";
        this.M_TN_LOOCL.operatingfromhour = data.OperatingFromHour;
        this.M_TN_LOOCL.operatingtohour = data.OperatingToHour;
        this.M_TN_LOOCL.telephonedeposit = this.isCurrency(
    ...
    SetLookUpBrand() {
      if (
        this.M_TN_LOOCL.contactid != null ||
        this.M_TN_LOOCL.contactid != ""
      ) {
    ...
    GetBaseCurrency() {
      ...
      this.FnDynamicFunction(param).then(ress => {
        ...
        this.M_TN_LOOCL.currencycdLabel =
          data.BaseCurrencyCd + this.separator + data.Descs;
      });
    },
    ...
    GetSpecificationData() {
      ...
      this.FnDynamicFunction(param).then(ress => {
        ...
        if (
          data.ApplicationCLRunningCd != null &&
          data.ApplicationCLRunningCd != ""
        ) {
    ...
    OnbrandcdChange(data) {
      ...
      this.$nextTick(() => {
        ...
        if (this.inputStatus != "VIEW") {
          this.PI_marketingid.dataLookUp.InitialWhere =
            "BrandCd = '" + data.id + "'";
        }
      });
      this.$forceUpdate();
    ...
    M_Post(dt) {},
    M_Insert() {
      if (this.M_TN_LOOCL.applicationno == "(auto)") {
        this.M_TN_LOOCL.applicationno = "null";
      }
      if (this.M_TN_LOOCL.loono == "(auto)") {
        this.M_TN_LOOCL.loono = "null";
      }
      var param = {
        ...
        LOODate:
          this.M_TN_LOOCL.loodate == "" || this.M_TN_LOOCL.loodate == null
            ? "NULL"
            : this.M_TN_LOOCL.loodate,
        CopyFromApplicationNo:
          this.M_TN_LOOCL.copyfromapplicationno == "" ||
          this.M_TN_LOOCL.copyfromapplicationno == null
            ? "NULL"
            : this.M_TN_LOOCL.copyfromapplicationno,
        CustomerType: "C",
        ContactId:
          this.M_TN_LOOCL.contactid == "" || this.M_TN_LOOCL.contactid == null
            ? "NULL"
            : this.M_TN_LOOCL.contactid,
        EventNo:
          this.M_TN_LOOCL.eventno == "" || this.M_TN_LOOCL.eventno == null
            ? "NULL"
            : this.M_TN_LOOCL.eventno,
        CustomerCategory:
          this.M_TN_LOOCL.customercategorycd == "" ||
        ...
        BrandCd:
          this.M_TN_LOOCL.brandcd == "" || this.M_TN_LOOCL.brandcd == null
            ? "NULL"
            : this.M_TN_LOOCL.brandcd,
        BrandName: this.M_TN_LOOCL.brandname,
        StartDate:
          this.M_TN_LOOCL.startdate == "" || this.M_TN_LOOCL.startdate == null
            ? "NULL"
            : this.M_TN_LOOCL.startdate,
        EndDate:
          this.M_TN_LOOCL.enddate == "" || this.M_TN_LOOCL.enddate == null
            ? "NULL"
            : this.M_TN_LOOCL.enddate,
        LeasePeriod: this.M_TN_LOOCL.leaseperiod,
        FreeRentalPeriod: this.M_TN_LOOCL.freerentalperiod,
        RCD:
          this.M_TN_LOOCL.rcd == "" || this.M_TN_LOOCL.rcd == null
            ? "NULL"
            : this.M_TN_LOOCL.rcd,
        RED:
          this.M_TN_LOOCL.red == "" || this.M_TN_LOOCL.red == null
            ? "NULL"
            : this.M_TN_LOOCL.red,
        UtilitiesStartDate:
          this.M_TN_LOOCL.utilitiesstartdate == "" ||
          this.M_TN_LOOCL.utilitiesstartdate == null
            ? "NULL"
            : this.M_TN_LOOCL.utilitiesstartdate,
        UtilitiesEndDate:
          this.M_TN_LOOCL.utilitiesenddate == "" ||
          this.M_TN_LOOCL.utilitiesenddate == null
            ? "NULL"
            : this.M_TN_LOOCL.utilitiesenddate,
        CurrencyCd:
          this.M_TN_LOOCL.currencycd == "" || this.M_TN_LOOCL.currencycd == null
            ? "NULL"
            : this.M_TN_LOOCL.currencycd,
        ...
        TelephoneLine:
          this.M_TN_LOOCL.telephoneline && this.M_TN_LOOCL.telephoneline != ""
            ? this.M_TN_LOOCL.telephoneline
            : 0,
        ...
        MediaCd:
          this.M_TN_LOOCL.mediacd == "" || this.M_TN_LOOCL.mediacd == null
            ? "NULL"
            : this.M_TN_LOOCL.mediacd,
        ServiceCharge: this.M_TN_LOOCL.servicecharge,
        PromotionLevy: this.M_TN_LOOCL.promotionlevy,
        TelephoneDeposit: this.M_TN_LOOCL.telephonedeposit
          ? this.replaceAllString(
              this.M_TN_LOOCL.telephonedeposit,
              ",",
              "",
              "number"
            )
    ...
    getDataBy(record) {
      ...
      this.postEncode(this.getUrlById(), param).then(response => {
        ...
        this.M_TN_LOOCL = {
          ...
          securitydepositrental: this.isCurrency(
            data.securitydepositrental,
            this.decimal
          ),
          securitydepositsc: this.isCurrency(
            data.securitydepositsc,
            this.decimal
          ),
        ...
        this.M_TN_LOOCL.customersource =
          data.customersource == "E" ? "EO" : "Direct";

        this.M_TN_LOOCL.copyfromapplicationnoLabel =
          this.M_TN_LOOCL.copyfromapplicationno != null &&
          this.M_TN_LOOCL.copyfromapplicationno != ""
            ? data.copyfromapplicationno + this.separator
            : "";
        this.M_TN_LOOCL.contactidLabel =
          this.M_TN_LOOCL.contactid != null && this.M_TN_LOOCL.contactid != ""
            ? data.contactid + this.separator + data.customername
            : "";
        this.M_TN_LOOCL.eventnoLabel =
          this.M_TN_LOOCL.eventno != null && this.M_TN_LOOCL.eventno != ""
            ? data.eventno + this.separator + data.eventdescs
            : "";
        this.M_TN_LOOCL.currencycdLabel =
          this.M_TN_LOOCL.currencycd != null && this.M_TN_LOOCL.currencycd != ""
    ...
    MdtRange_rcd(data) {
      if (this.inputStatus != "VIEW") {
        ...
        if (this.M_TN_LOOCL.eventno && this.M_TN_LOOCL.eventnoLabel != "") {
          if (
            this.M_TN_LOOCL.leaseperiod &&
            this.M_TN_LOOCL.leaseperiod != ""
          ) {
            this.M_TN_LOOCL.red = this.dateAdd2(
              "d",
              data,
              this.M_TN_LOOCL.leaseperiod - 1
            );
          }
        } else {
          if (
            ...
            this.M_TN_LOOCL.utilitiesenddate = this.dateAdd2(
              "d",
              data,
              this.M_TN_LOOCL.leaseperiod - 1
            );
