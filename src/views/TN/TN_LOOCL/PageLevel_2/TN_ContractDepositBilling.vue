...
export default {
    ...
    methods: {
        getDefault(){
            var param = {
                OptionFunctionCd: "TNContractDepositBilling_GetDefault",
            ...
            .then(ress => {
                ...
                this.M_TN_ContractDepositBilling.addresscdLabel = data.AddressCd + this.separator + data.Address1
                this.M_TN_ContractDepositBilling.contactid = data.ContactID
          ...
          .then(ress => {
            if (ress == null || ress.length < 1) {
              ...
              .then(ress => {
                ...
                this.FnGetCreditTermsData(data.CreditTermsCd).then(dt => {
                    if (dt != null) {
                        var dtcterm = dt[0]
                        this.M_TN_ContractDepositBilling.dueday = dtcterm.Dueday
                        if (dtcterm.Dueday != null && dtcterm.Dueday != '') {
                            if (this.M_TN_ContractDepositBilling.billingdate && this.M_TN_ContractDepositBilling.billingdate != '') {
                                this.M_TN_ContractDepositBilling.billingduedate = this.dateAdd2( 'd', this.M_TN_ContractDepositBilling.billingdate, dtcterm.Dueday )
                            }
                        }
                    }
                })
        ...
        this.$nextTick(() => {
            ...
            if (this.inputStatus != "VIEW") {
                ...
                .then(dt => {
                  ...
                  var datas = dt[0]
                  this.M_TN_ContractDepositBilling.descs = datas.TrxTypeDescs
                  if (!this.M_TN_ContractDepositBilling.currencycd || this.M_TN_ContractDepositBilling.currencycd == '') {
                      this.M_TN_ContractDepositBilling.currencycd = datas.CurrencyCd
                      this.M_TN_ContractDepositBilling.currencycdLabel = datas.CurrencyCd
                  }
                    ...
                    .then(ress => {
                        ...
                        if (this.ContractData.ChargeArea == 'N') {
                            totalarea = this.ContractData.TotalNetArea
                        }
                        else if (this.ContractData.ChargeArea == 'S') {
                            totalarea = this.ContractData.TotalSemiGrossArea
                        }
                        else {
                            totalarea = this.ContractData.TotalGrossArea
                        }

                        if (dataMap.TenancyChargeType.toString() == '1') {
                            depamt = parseFloat(this.ContractData.BaseRentalRate) * totalarea * parseFloat(this.ContractData.SecurityDepositRental)
                        }
                        else if (dataMap.TenancyChargeType.toString() == '2') {
                            depamt = parseFloat(this.ContractData.ServiceCharge) * totalarea * parseFloat(this.ContractData.SecurityDepositSC)
                        }

                        this.M_TN_ContractDepositBilling.depositamt = this.isCurrency(depamt, this.decimal)
                        this.getCreditTerm()
                    })
                })
            }
        ...
        this.$nextTick(() => {
            if (this.inputStatus != "VIEW") {
                if (data && data != '') {
                    if (this.M_TN_ContractDepositBilling.dueday && this.M_TN_ContractDepositBilling.dueday != '') {
