              ...
              <b-row style="padding-left:10px;">
                <b-col md="12" id="col-left">
                  ...
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        ...
                        :prop="PI_trxtype"
                        :value="M_TN_LOOCharges.trxtype"
                        :label="M_TN_LOOCharges.trxtypeLabel"
                        ref="ref_trxtype"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSInputSelect2
                        ...
                        :prop="PI_billingcycle"
                        :value="M_TN_LOOCharges.billingcycle"
                        :label="M_TN_LOOCharges.billingcycleLabel"
                        ref="ref_billingcycle"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_descs"
                        v-model="M_TN_LOOCharges.descs"
                        ref="ref_descs"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billinginterval"
                        v-model="M_TN_LOOCharges.billinginterval"
                        ref="ref_billinginterval"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelect2
                        ...
                        :prop="PI_chargetype"
                        :value="M_TN_LOOCharges.chargetype"
                        :label="M_TN_LOOCharges.chargetypeLabel"
                        ref="ref_chargetype"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billingday"
                        v-model="M_TN_LOOCharges.billingday"
                        ref="ref_billingday"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      ...
                      <ABSInputSelectList
                        ...
                        :prop="PI_addresscd"
                        :value="M_TN_LOOCharges.addresscd"
                        :label="M_TN_LOOCharges.addresscdLabel"
                        ref="ref_addresscd"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billingmonth"
                        v-model="M_TN_LOOCharges.billingmonth"
                        ref="ref_billingmonth"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        ...
                        :prop="PI_currencycd"
                        :value="M_TN_LOOCharges.currencycd"
                        :label="M_TN_LOOCharges.currencycdLabel"
                        ref="ref_currencycd"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billingdueday"
                        v-model="M_TN_LOOCharges.billingdueday"
                        ref="ref_billingdueday"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSInputSelectList
                        ...
                        :value="M_TN_LOOCharges.credittermscd"
                        :label="M_TN_LOOCharges.credittermscdLabel"
                        ref="ref_credittermscd"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billingduemonth"
                        v-model="M_TN_LOOCharges.billingduemonth"
                        ref="ref_billingduemonth"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputDateRangeVuex
                        :prop="PI_startdate"
                        :valueFrom="M_TN_LOOCharges.startdate"
                        :valueTo="M_TN_LOOCharges.enddate"
                        ref="ref_startdate"
                    ...
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_totalarea"
                        v-model="M_TN_LOOCharges.totalarea"
                        ref="ref_totalarea"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        ...
                        v-model="M_TN_LOOCharges.termspayment"
                        ref="ref_termspayment"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        @onBlur="OnbillingrateBlur"
                        :prop="PI_billingrate"
                        v-model="M_TN_LOOCharges.billingrate"
                        ref="ref_billingrate"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        @input="OnchargebasisChange"
                        :prop="PI_chargebasis"
                        v-model="M_TN_LOOCharges.chargebasis"
                        ref="ref_chargebasis"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        ...
                        v-model="M_TN_LOOCharges.amortizemonthlyamt"
                  ...
                  <b-row>
                    <b-col md="6">
                      ...
                      <ABSinputRadioButtonVuex
                        @input="OnbillingperioddescsChange"
                        :prop="PI_billingperioddescs"
                        v-model="M_TN_LOOCharges.billingperioddescs"
                        ref="ref_billingperioddescs"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        @input="OnbillingpercentChange"
                        :prop="PI_billingpercent"
                        v-model="M_TN_LOOCharges.billingpercent"
                        ref="ref_billingpercent"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        @input="OnbillingnumberingdescsChange"
                        :prop="PI_billingnumberingdescs"
                        v-model="M_TN_LOOCharges.billingnumberingdescs"
                        ref="ref_billingnumberingdescs"
                      />
                    </b-col>
                    <b-col md="6">
                      <ABSinputTextVuex
                        @input="OnbillingfrequencyChange"
                        :prop="PI_billingfrequency"
                        v-model="M_TN_LOOCharges.billingfrequency"
                        ref="ref_billingfrequency"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="6">
                      <ABSinputRadioButtonVuex
                        ...
                        v-model="M_TN_LOOCharges.billingmethod"
                    ...
                    <b-col md="6">
                      <ABSinputTextVuex
                        :prop="PI_billingamt"
                        v-model="M_TN_LOOCharges.billingamt"
                        ref="ref_billingamt"
                      />
                    </b-col>
                  </b-row>
                  <b-row>
                    ...
                    <b-col md="6">
                      <ABSTextAreaVuex
                        ...
                        :prop="PI_remarks"
                        v-model="M_TN_LOOCharges.remarks"
                        ref="ref_remarks"
                      />
                    </b-col>
                  </b-row>
...
export default {
  ...
  data() {
    return {
      ...
      PI_trxtype: {
        dataLookUp: {
          LookUpCd: "GetLookupTrxTypeTNCL",
          ColumnDB: "TrxType",
          InitialWhere:
            "SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "'",
          ParamWhere: "",
          SourceField:
            "TransType=TrxType,Descs,Type=TenancyChargeType,TenancyChargeTypeDescription,TimeEdit",
      ...
      PI_addresscd: {
        dataLookUp: {
          ...
          ParamWhere: "",
          SourceField:
            "AddressCd,TranslatedAddressType=AddressType,Address1,Address2,Address3,Address4,CityName=City,ContactID,Name,TimeEdit",
          DisplayColumn: "AddressCd,Address1"
        },
        cValidate: "required",
        cName: "addresscd",
      ...
      PI_chargebasis: {
        ...
        cRadioOptions: [
          { text: "Fix", value: "F" },
          { text: "Per Area", value: "A" },
          { text: "Contract Amount", value: "C" }
        ],
      ...
      PI_billingmethod: {
        ...
        cRadioOptions: [
          { text: "Full Month", value: "F" },
          { text: "Cut Off Date", value: "C" }
        ],
        cRadioDefaultOption: "F",
  ...
  methods: {
    CalculateBillingAmt() {
      ...
      var RentalRateLot = this.replaceAllString(
        data.RentalRate,
        ",",
        "",
        "number"
      );
      var AreaH = this.replaceAllString(
        this.M_TN_LOOCharges.totalarea,
        ",",
        "",
        "number"
      );
      var LeasePeriodH = this.ContractData.LeasePeriod;
      var TotalRate = "";
      var BillFreq = this.replaceAllString(
        this.M_TN_LOOCharges.billingfrequency,
        ",",
        "",
        "number"
      );
      var BillPerc = this.replaceAllString(
      ...
      // console.log(RentalRateLot, AreaH, LeasePeriodH, this.FixChargesLot, BillFreq, BillPerc);
      if (this.FixChargesLot == "Y") {
        TotalRate = RentalRateLot * LeasePeriodH;
      } else if (this.FixChargesLot == "N") {
        TotalRate = RentalRateLot * LeasePeriodH * AreaH;
      }

      // console.log(TotalRate);

      if (BillFreq > 0) {
        // total = this.isCurrency((TotalRate * (BillPerc / 100)) / BillFreq, this.decimal)
        total = (TotalRate * (BillPerc / 100)) / BillFreq;
      }

      this.M_TN_LOOCharges.billingamt = this.isCurrency(total, this.decimal);

      // console.log(this.M_TN_LOOCharges.billingamt);
    },
    getCreditTerm() {
      var param = {
        OptionFunctionCd: "GetCreditTerms",
        ModuleCdV2: "AR",
        SubPortfolioCd: this.getDataUser().SubPortfolioCd,
        ModuleCd: "AR",
        TrxType: this.M_TN_LOOCharges.trxtype
      };

      this.FnDynamicFunction(param).then(ress => {
        if (ress == null || ress.length < 1) {
          var param = {
            OptionFunctionCd: "GetCreditTerms2",
            ModuleCdV2: "AR",
            ModuleCd: "AR",
            TrxType: this.M_TN_LOOCharges.trxtype
          };
          ...
          this.FnDynamicFunction(param).then(ress => {
            if (ress == null) return;
            var data = ress[0];
            this.M_TN_LOOCharges.credittermscd = data.CreditTermsCd;
            this.M_TN_LOOCharges.credittermscdLabel = data.CreditTermsCd;
          });
        } else {
          var data = ress[0];
          this.M_TN_LOOCharges.credittermscd = data.CreditTermsCd;
    ...
    OntrxtypeChange(data) {
      ...
      this.$nextTick(() => {
        ...
        this.M_TN_LOOCharges.trxtypeLabel = data.id + " | " + data.label;
        this.M_TN_LOOCharges.descs = data.Descs;
        this.M_TN_LOOCharges.chargetype = data.Type;
        this.M_TN_LOOCharges.chargetypeLabel =
          data.TenancyChargeTypeDescription;
        if (this.inputStatus != "VIEW") {
          var param = {
            OptionFunctionCd: "GetLeasingPolicy",
          ...
          this.FnDynamicFunction(param).then(ress => {
            ...
            var dataL = ress[0];
            if (data.Type == "A") {
              this.M_TN_LOOCharges.billingpercent = this.isCurrency(
                dataL.DPPPercentage,
                this.decimal
              );
              this.M_TN_LOOCharges.billingfrequency = this.isCurrency(
                dataL.DPSchedule,
                this.decimal
              );
              this.M_TN_LOOCharges.billingrate = this.isCurrency(
                1,
                this.decimal
              );
              this.M_TN_LOOCharges.billingamt = this.isCurrency(
    ...
    OnbillingrateBlur(data) {
      this.$nextTick(() => {
        if (this.inputStatus != "VIEW") {
          if (this.M_TN_LOOCharges.chargebasis == "F") {
            this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency(
              data,
              this.decimal
            );
            ...
            var amt = parseFloat(billingrate) * parseFloat(totalarea);
            this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency(
              amt,
              this.decimal
            );
      ...
      this.$nextTick(() => {
        if (this.inputStatus != "VIEW") {
          if (data == "F") {
            ...
            this.M_TN_LOOCharges.amortizemonthlyamt = this.M_TN_LOOCharges.billingrate;
            this.PI_billingrate.cProtect = false;
    ...
    paramFromParent() {
      ...
      // console.log(data);
      this.FixChargesLot = data.FixCharges;
      ...
      // this.PI_addresscd.cMasterUrl = 'Custom/CS_ContactAddress?oid=E7AC288B0F2D41445904D071BA37AAFF&ContactId=' + data.ContactId
    ...
    M_Insert() {
      var param = {
        ...
        LotNo:
          this.M_TN_LOOCharges.lotno == "" || this.M_TN_LOOCharges.lotno == null
            ? "NULL"
            : this.M_TN_LOOCharges.lotno,
        TrxType:
          this.M_TN_LOOCharges.trxtype == "" ||
          this.M_TN_LOOCharges.trxtype == null
            ? "NULL"
            : this.M_TN_LOOCharges.trxtype,
        Descs: this.M_TN_LOOCharges.descs,
        CurrencyCd:
          this.M_TN_LOOCharges.currencycd == "" ||
          this.M_TN_LOOCharges.currencycd == null
            ? "NULL"
            : this.M_TN_LOOCharges.currencycd,
        CreditTermsCd:
          this.M_TN_LOOCharges.credittermscd == "" ||
          this.M_TN_LOOCharges.credittermscd == null
            ? "NULL"
            : this.M_TN_LOOCharges.credittermscd,
        ...
        TotalArea: this.M_TN_LOOCharges.totalarea
          ? this.replaceAllString(
              this.M_TN_LOOCharges.totalarea,
              ",",
              "",
          ...
          : 0,
        BillingRate: this.M_TN_LOOCharges.billingrate
          ? this.replaceAllString(
              this.M_TN_LOOCharges.billingrate,
              ",",
              "",
          ...
          : 0,
        AmortizeMonthlyAmt: this.M_TN_LOOCharges.amortizemonthlyamt
          ? this.replaceAllString(
              this.M_TN_LOOCharges.amortizemonthlyamt,
              ",",
              "",
          ...
          : 0,
        BillingPercent: this.M_TN_LOOCharges.billingpercent
          ? this.replaceAllString(
              this.M_TN_LOOCharges.billingpercent,
              ",",
              "",
        ...
        BillingFrequency: this.M_TN_LOOCharges.billingfrequency
          ...
          : 0,
        BillingAmt: this.M_TN_LOOCharges.billingamt
          ? this.replaceAllString(
              this.M_TN_LOOCharges.billingamt,
              ",",
              "",
        ...
        StartDate:
          this.M_TN_LOOCharges.startdate == "" ||
          this.M_TN_LOOCharges.startdate == null
            ? "NULL"
            : this.M_TN_LOOCharges.startdate,
        EndDate:
          this.M_TN_LOOCharges.enddate == "" ||
          this.M_TN_LOOCharges.enddate == null
            ? "NULL"
            : this.M_TN_LOOCharges.enddate,
        AddressContactId:
          this.M_TN_LOOCharges.addresscontactid &&
          this.M_TN_LOOCharges.addresscontactid != ""
            ? this.M_TN_LOOCharges.addresscontactid
            : this.M_TN_LOOCharges.contactid,
        AddressCd:
          this.M_TN_LOOCharges.addresscd == "" ||
          this.M_TN_LOOCharges.addresscd == null
            ? "NULL"
            : this.M_TN_LOOCharges.addresscd,
    ...
    M_New() {
      ...
      this.M_TN_LOOCharges.applicationno = data.ApplicationNo;
      this.M_TN_LOOCharges.startdate = this.momentDateFormat(
        this.ContractData.RCD,
        "YYYY-MM-DD"
      );
      this.M_TN_LOOCharges.enddate = this.momentDateFormat(
        this.ContractData.RED,
        "YYYY-MM-DD"
      );

      if (this.ContractData.ChargeArea == "G") {
        this.M_TN_LOOCharges.totalarea = this.isCurrency(
          this.ContractData.TotalGrossArea,
          this.decimal
        );
      } else if (this.ContractData.ChargeArea == "S") {
        this.M_TN_LOOCharges.totalarea = this.isCurrency(
          this.ContractData.TotalSemiGrossArea,
          this.decimal
        );
      } else if (this.ContractData.ChargeArea == "N") {
        this.M_TN_LOOCharges.totalarea = this.isCurrency(
          this.ContractData.TotalNetArea,
          this.decimal
        );
      }
    },
    ...
    getDataBy(record) {
      ...
      this.postEncode(this.getUrlById(), param).then(response => {
        ...
        this.M_TN_LOOCharges = {
          chargessequenceno: this.isCurrency(
            data.chargessequenceno,
            this.decimal
          ),
          ...
          billingfrequency: this.isCurrency(
        ...
        this.M_TN_LOOCharges.trxtypeLabel =
          this.M_TN_LOOCharges.trxtype != null &&
          this.M_TN_LOOCharges.trxtype != ""
            ? data.trxtype + this.separator + data.trxdescs
            : "";
        this.M_TN_LOOCharges.lotnoLabel =
          this.M_TN_LOOCharges.lotno != null && this.M_TN_LOOCharges.lotno != ""
            ? data.lotno + this.separator
            : "";
        this.M_TN_LOOCharges.addresscdLabel =
          this.M_TN_LOOCharges.addresscd != null &&
          this.M_TN_LOOCharges.addresscd != ""
            ? data.addresscd + this.separator + data.address1
            : "";
        this.M_TN_LOOCharges.currencycdLabel =
          this.M_TN_LOOCharges.currencycd != null &&
          this.M_TN_LOOCharges.currencycd != ""
            ? data.currencycd + this.separator + data.currencydescs
            : "";
        this.M_TN_LOOCharges.credittermscdLabel =
          this.M_TN_LOOCharges.credittermscd != null &&
          this.M_TN_LOOCharges.credittermscd != ""
    ...
    getContractData(appNo) {
      ...
      this.FnDynamicFunction(param).then(ress => {
        ...
        // console.log(this.PI_addresscd.cMasterUrl)
        this.PI_addresscd.cParamUrl = "ContactId=" + ress[0].ContactId;
        console.log(this.PI_addresscd.cParamUrl);
      });
    }
  },
  created: function() {},
