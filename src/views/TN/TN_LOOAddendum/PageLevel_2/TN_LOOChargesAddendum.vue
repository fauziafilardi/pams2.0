						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="6" id="col-left"> <!-- table open -->
                                    ...
                                    <b-row>
                                      <b-col  md="12">
                                        <ABSinputTextVuex :prop="PI_descs" v-model="M_TN_LOOCharges.descs"  ref="ref_descs"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="12">
                                        <ABSInputSelect2 @change="OnchargetypeChange" :prop="PI_chargetype" :value="M_TN_LOOCharges.chargetype" :label="M_TN_LOOCharges.chargetypeLabel" ref="ref_chargetype"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="12">
                                ...
                                <b-col md="6" id="col-right">
                                    ...
                                    <b-row>
                                      <b-col md="12">
                                        <ABSinputTextVuex :prop="PI_billingpercent" v-model="M_TN_LOOCharges.billingpercent"  ref="ref_billingpercent"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col md="12">
                                        <ABSinputTextVuex :prop="PI_billingfrequency" v-model="M_TN_LOOCharges.billingfrequency"  ref="ref_billingfrequency"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col md="12">
    ...
    methods: {
      GetContractAddendumData(){
          var param = {
            ...
            AddendumSequenceNo: this.M_TN_LOOCharges.addendumsequenceno
          }
      ...
      SetOptionControlStateByChargeType(){
        ...
        switch(this.M_TN_LOOCharges.chargetype){
          case "A":
              this.PI_installmentmethod.cProtect = false
      ...
      SetEditableBillingControl(from){
        ...
        if(this.M_TN_LOOCharges.chargebasis=='C'){
            this.PI_billingmethod.cProtect = true
        }else{
        ...
        SetDefaultValue(){
          ...
          this.PI_billingamt.cProtect = true
          this.PI_billingfrequency.cProtect = false
          // console.log('SetDefaultValue','PI_billingfrequency false')
            ...
            this.FnDynamicFunction(param)
                .then(ress => {
                  ...
                  if(data.DPSchedule !=null && data.DPSchedule!=0){
                    this.M_TN_LOOCharges.contractamt = data.ContractAmt
                    ...
                    this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency((ctramt * dppercent)/100/dps, this.decimal)
                  }else{
        ...
        GetLeasingPolicyRentalDataDefault(){
            ...
            this.FnDynamicFunction(param)
                .then(ress => {
                  ...
                  this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency(data.ContractAmt, this.decimal)
                  this.M_TN_LOOCharges.billingrate = ''
                  ...
                  this.FnDynamicFunction(param2)
                    .then(ress => {
                      ...
                      if(parseInt(this.M_TN_LOOCharges.billingfrequency)==0){
                        ...
                        var blg = this.isCurrency((this.M_TN_LOOCharges.billingamt * this.M_TN_LOOCharges.billingpercent)/100/this.M_TN_LOOCharges.BillingFrequency, this.decimal)
                          this.M_TN_LOOCharges.billingamt = blg
                          this.M_TN_LOOCharges.amortizemonthlyamt = blg
                      }
        ...
        GetBillingRate(){
            ...
            //       var data = ress[0]
                  ...
                  var billRate = this.M_TN_LOOCharges.billingrate == '' || this.M_TN_LOOCharges.billingrate == null ? 0 : parseFloat(this.replaceAllString(this.M_TN_LOOCharges.billingrate, ',', '', 'number'))
                  var ttlArea = this.M_TN_LOOCharges.totalarea == '' || this.M_TN_LOOCharges.totalarea == null ? 0 : parseFloat(this.replaceAllString(this.M_TN_LOOCharges.totalarea, ',', '', 'number'))
        ...
        RecalculateBillingAmt(){
          if(this.M_TN_LOOCharges.chargebasis=='A'){
              ...
              var billInter = this.M_TN_LOOCharges.billinginterval == '' || this.M_TN_LOOCharges.billinginterval == null ? 0 : parseInt(this.M_TN_LOOCharges.billinginterval)

              // console.log(billRate,ttlArea,billInter)
              this.M_TN_LOOCharges.billingamt = this.isCurrency((billRate*ttlArea*billInter), this.decimal)
              this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency((billRate*ttlArea*billInter), this.decimal)
          }
              ...
              var totalrental = this.M_TN_LOOCharges.contractamt == '' || this.M_TN_LOOCharges.contractamt == null ? 0 : parseFloat(this.M_TN_LOOCharges.contractamt)
              ...
              var billFreq = this.M_TN_LOOCharges.billingfrequency == '' || this.M_TN_LOOCharges.billingfrequency == null ? '' : parseFloat(this.M_TN_LOOCharges.billingfrequency)
              
              if(billFreq == 0){
                this.M_TN_LOOCharges.billingamt = this.isCurrency((totalrental * (billPercent / 100)), this.decimal)
                this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency((totalrental * (billPercent / 100)), this.decimal)
              }
              else{
                this.M_TN_LOOCharges.billingamt = this.isCurrency((totalrental * (billPercent / 100) / billFreq), this.decimal)
                this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency((totalrental * (billPercent / 100) / billFreq), this.decimal)
              }
        ...
        OnchargetypeChange (data) {
          this.$nextTick(() => {
            // this.M_TN_LOOCharges.chargetype = data.id
            if (this.inputStatus != "VIEW") {
            }
          })
          this.$forceUpdate()
              ...
              var lot = data.id.trim() != ''? data.id.trim() :''
                 var param = {
                  ...
                  .then(ress => {
                    // if (ress == null) return
                    if (ress.length > 0) {
                      this.M_TN_LOOCharges.totalarea = ress[0].TotalArea
                    }
                    this.RecalculateBillingAmt()
                  })
            }
...
//{billingmethod}
    ...
    M_CheckboxChecked (data, status, index) {
        if (status === true) {
          // console.log(data)
          if (data.InstallmentMethod && data.InstallmentMethod == 'N') {
		...
		paramFromParent(){
            ...
            this.M_TN_LOOCharges.addendumsequenceno = data.AddendumSequenceNo
            ...
            this.getContractData(data.ApplicationNo, data.AddendumSequenceNo)
            this.FormToABSList().doGetList('','eb_getList')
        },		       
        M_Insert() {
          var param = {
              OptionFunctionCd: "CheckContractChargesPercentAddendum",
              ModuleCd: this.Module,
              SubPortfolioCd: this.getDataUser().SubPortfolioCd,
              ApplicationNo: this.DataRowPage1.ApplicationNo,
        ...
        M_Update() {
          var param = {
              ...
              SubPortfolioCd: this.getDataUser().SubPortfolioCd,
              ApplicationNo: this.DataRowPage1.ApplicationNo,
              AddendumSequenceNo: this.DataRowPage1.AddendumSequenceNo.toString(),
              ChargesSequenceNo: this.DataRowPage1.ApplicationNo,
              Status: 'A'
          }
          this.FnDynamicFunction(param)
              .then(ress => {
...
this.M_TN_LOOCharges = {
                ...
                billinginterval: this.isCurrency(data.billinginterval, this.decimal),
                billingday: this.isCurrency(data.billingday, this.decimal),
                billingmonth: this.isCurrency(data.billingmonth, this.decimal),
                ...
                rowid: data.rowid
                 ...
                 if(data.chargebasis == 'C' && data.installmentmethod != 'N'){
                    if(data.BillingFrequency>0){
                      var blg = this.isCurrency(data.billingamt / data.billingfrequency, this.decimal)
                        this.M_TN_LOOCharges.billingamt = blg
                        this.M_TN_LOOCharges.amortizemonthlyamt = blg
                    }
                }
        ...
        getContractData (appNo, sNo) {
          var param = {
            OptionFunctionCd: "GetContractDataAddendum2",
            ModuleCd: "TN",
            SubPortfolioCd: this.getDataUser().SubPortfolioCd,
            ApplicationNo: appNo,
            AddendumSequenceNo: sNo
          }
