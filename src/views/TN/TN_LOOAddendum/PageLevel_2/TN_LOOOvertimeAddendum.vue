    ...
    methods: {
        ...
        GetDefault(){
            var param = {
                ...
                ModuleCd: this.Module,
                SubPortfolioCd: this.getDataUser().SubPortfolioCd,
                OvertimeCd: this.M_TN_ContractOvertime.overtimecd
            }
            ...
            .then(ress => {
              ...
              var data = ress[0]
                ...
                this.M_TN_ContractOvertime.chargevalue = data.ChargeValue
            })
        },
...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_TN_ContractOvertime.addendumsequenceno = data.AddendumSequenceNo
        ...
        M_Insert() {
            var param = {			
                ...
                AddendumSequenceNo: this.M_TN_ContractOvertime.addendumsequenceno,
