...
export default {
    ...
    methods: {
        GetDefault(){
            var param = {
                OptionFunctionCd: "GetDefaultContractDepositBillingAddendum",
                ModuleCd: this.Module,
                SubPortfolioCd: this.getDataUser().SubPortfolioCd,
                ApplicationNo: this.M_TN_ContractDepositBilling.applicationno,
                AddendumSequenceNo: this.M_TN_ContractDepositBilling.addendumsequenceno,
            ...
            .then(ress => {
                ...
                this.M_TN_ContractDepositBilling.addresscontactid = data.ContactID
        ...
        GetTrxTypeDataRow(){
            var param = {
                OptionFunctionCd: "GetTrxTypeDataRow",
        ...
        GetContractAddendumData(){
            ...
            .then(ress => {
                if (ress == null) return
                var data = ress[0]
                console.log(data.LOODate)
                // this.M_TN_ContractDepositBilling.loodate = data.LOODate
            })
        },
        GetDefaultDepositBilling(){
            ...
            .then(ress => {
                ...
                var data = ress[0]
                var totalArea = 0
                switch (data.ChargeArea) {
                    case "N":
                        this.totalArea = data.TotalNetArea
                        break;
                    case "S":
                        this.totalArea = data.TotalSemiGrossArea
                        break;
                    default:
                        this.totalArea = data.TotalNetArea
                        break;
            ...
            var param = {
                OptionFunctionCd: "DepositeBilling",
                ModuleCd: this.Module,
                SubPortfolioCd: this.getDataUser().SubPortfolioCd,
                TrxType: this.M_TN_ContractDepositBilling.trxtype
            }
            ...
            .then(ress => {
                if (ress == null) return
                var data = ress[0]
                console.log("DepositeBilling")
                console.log(data)
                if(data.TenancyChargeType == "1"){
                    this.depBilling = data.BaseRentalRate * this.totalArea * data.SecurityDepositRental
                }else if(data.TenancyChargeType == "2"){
                    this.depBilling = data.ServiceCharge * this.totalArea * data.SecurityDepositSC
                }
            })

            this.M_TN_ContractDepositBilling.depositamt = this.isCurrency(this.depBilling, this.decimal)
            console.log(this.M_TN_ContractDepositBilling.depositamt)

        },
        DisplayCreditTerms(CreditTermsCd){
            if(CreditTermsCd != '' || CreditTermsCd != null){
                var param = {
                    OptionFunctionCd: "DisplayCreditTerms",
                    ModuleCd: this.Module,
        ...
        GetCreditTerms(){
        var CreditTermsCd = ""
        if(this.M_TN_ContractDepositBilling.trxtype != "" || this.M_TN_ContractDepositBilling.trxtype != null){
          var param = {
          ...
          .then(ress => {
            if (ress == null) return
              var data = ress[0]
              // this.M_TN_ContractDepositBilling.credittermscd = data.CreditTermsCd
              // this.M_TN_ContractDepositBilling.credittermscdLabel = data.CreditTermsCd
              this.CreditTermsCd = data.CreditTermsCd
          })
        ...
        this.DisplayCreditTerms(this.CreditTermsCd)
        this.M_TN_ContractDepositBilling.credittermscd = this.CreditTermsCd
        this.M_TN_ContractDepositBilling.credittermscdLabel = this.CreditTermsCd
      },
        ...
        this.$nextTick(() => {
            if (this.inputStatus != "VIEW") {
                if (this.M_TN_ContractDepositBilling.dueday != null && this.M_TN_ContractDepositBilling.dueday != '') {
                    if (data && data != '') {
                    this.M_TN_ContractDepositBilling.billingduedate = this.dateAdd2( 'd', data, this.M_TN_ContractDepositBilling.dueday )
                    }
                }
            }
        })
                    ...
                    if (dt != null) {
                        ...
                        if (data.Dueday != null && data.Dueday != '') {
                            if (this.M_TN_ContractDepositBilling.billingdate && this.M_TN_ContractDepositBilling.billingdate != '') {
                                this.M_TN_ContractDepositBilling.billingduedate = this.dateAdd2( 'd', this.M_TN_ContractDepositBilling.billingdate, data.Dueday )
                            }
                        }
                    }
                })
...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_TN_ContractDepositBilling.addendumsequenceno = data.AddendumSequenceNo
...
this.M_TN_ContractDepositBilling = {
    addendumsequenceno: this.DataRowPage1.AddendumSequenceNo,
                ...
                this.M_TN_ContractDepositBilling.currencycdLabel = this.M_TN_ContractDepositBilling.currencycd != null && this.M_TN_ContractDepositBilling.currencycd != '' ? data.currencycd  :'' 
