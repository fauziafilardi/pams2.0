            ...
            <b-collapse id="collapse1" :visible="true">
              ...
              <b-row style="padding-left:10px;">
                <b-col md="6" id="col-left"> <!-- table open -->
                    <b-row>
                      <b-col  md="12">
                        <ABSInputSelectList @change="OnapplicationnoChange" :prop="PI_applicationno" :value="M_TN_LOOAddendum.applicationno" :label="M_TN_LOOAddendum.applicationnoLabel" ref="ref_applicationno"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_addendumrefno" v-model="M_TN_LOOAddendum.addendumrefno"  ref="ref_addendumrefno"/>
                      </b-col>
                    </b-row>

                    <b-row>
                      <b-col md="12">
                        <ABSinputDateVuex @input="OnaddendumdateChange" :prop="PI_addendumdate" v-model="M_TN_LOOAddendum.addendumdate"  ref="ref_addendumdate" />
                      </b-col>
                    </b-row>

                    <b-row>
                      <b-col md="12">
                        <ABSInputSelectList @change="OnaddendumtypecdChange" :prop="PI_addendumtypecd" :value="M_TN_LOOAddendum.addendumtypecd" :label="M_TN_LOOAddendum.addendumtypecdLabel" ref="ref_addendumtypecd"/>
                      </b-col>
                    </b-row>

                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_loono" v-model="M_TN_LOOAddendum.loono"  ref="ref_loono"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputDateVuex @input="OnloodateChange" :prop="PI_loodate" v-model="M_TN_LOOAddendum.loodate"  ref="ref_loodate" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        ...
                        <ABSinputTextVuex :prop="PI_contactid" v-model="M_TN_LOOAddendum.contactidLabel"  ref="ref_contactid" />
                        <!-- <b-row>
                          <b-col md="12">
                            <b-row>
                    ...
                    <b-row>
                      <b-col  md="12">
                        ...
                        <ABSinputTextVuex :prop="PI_customercategorycd" v-model="M_TN_LOOAddendum.customercategorycdLabel"  ref="ref_customercategorycd" />
                        <!-- <b-row>
                          <b-col md="12">
                            <b-row>
                              <b-col md="4" class="lbl-col-align">
                    ...
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_assessmentno" v-model="M_TN_LOOAddendum.assessmentno"  ref="ref_assessmentno"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_customerstatus" v-model="M_TN_LOOAddendum.customerstatus"  ref="ref_customerstatus" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_referenceno" v-model="M_TN_LOOAddendum.referenceno"  ref="ref_referenceno"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSInputSelectList @change="OnbrandcdChange" :prop="PI_brandcd" :value="M_TN_LOOAddendum.brandcd" :label="M_TN_LOOAddendum.brandcdLabel" ref="ref_brandcd"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_theme" v-model="M_TN_LOOAddendum.theme"  ref="ref_theme" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_class" v-model="M_TN_LOOAddendum.class"  ref="ref_class" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_category" v-model="M_TN_LOOAddendum.category"  ref="ref_category" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputDateRangeVuex :prop="PI_startdate" :valueFrom="M_TN_LOOAddendum.startdate" :valueTo="M_TN_LOOAddendum.enddate" ref="ref_startdate" @from="MdtRange_startdate" @to="MdtRange_enddate" @fromBlur="BlurRange_startdate" @toBlur="BlurRange_enddate" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <b-row>
                          ...
                          <b-col md="1" style="margin-left: 10px;">
                            <ABSTextBoxOnly :prop="PI_leaseperiod" v-model="M_TN_LOOAddendum.leaseperiod"  ref="ref_leaseperiod"/>    
                          </b-col>
                          <b-col md="4">
                            <label :class="inputStatus=='VIEW' ? 'lbl-view-form' : 'text-field-form'" for="">{{M_TN_LOOAddendum.chargeperiod}} and {{M_TN_LOOAddendum.perioddays}} days. Free </label>
                          </b-col>  
                          <b-col md="1">
                            <ABSTextBoxOnly :prop="PI_freerentalperiod" v-model="M_TN_LOOAddendum.freerentalperiod"  ref="ref_freerentalperiod"/>                                            
                          </b-col>
                        </b-row>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputDateRangeVuex :prop="PI_rcd" :valueFrom="M_TN_LOOAddendum.rcd" :valueTo="M_TN_LOOAddendum.red" ref="ref_rcd" @from="MdtRange_rcd" @to="MdtRange_red" @fromBlur="BlurRange_rcd" @toBlur="BlurRange_red"/>
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputDateRangeVuex :prop="PI_utilitiesstartdate" :valueFrom="M_TN_LOOAddendum.utilitiesstartdate" :valueTo="M_TN_LOOAddendum.utilitiesenddate" ref="ref_utilitiesstartdate" @from="MdtRange_utilitiesstartdate" @to="MdtRange_utilitiesenddate" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        ...
                        <ABSinputTextVuex :prop="PI_currencycd" v-model="M_TN_LOOAddendum.currencycdLabel"  ref="ref_currencycd" />
                        <!-- <b-row>
                          <b-col md="12">
                            <b-row>
                              <b-col md="4" class="lbl-col-align">
                    ...
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_totalrental" v-model="M_TN_LOOAddendum.totalrental"  ref="ref_totalrental" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputRadioButtonVuex @input="OnantennastatusChange" :prop="PI_antennastatus" v-model="M_TN_LOOAddendum.antennastatus"  ref="ref_antennastatus" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputRadioButtonVuex @input="OnpeggingrateChange" :prop="PI_peggingrate" v-model="M_TN_LOOAddendum.peggingrate"  ref="ref_peggingrate" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputRadioButtonVuex @input="OnchargeareaChange" :prop="PI_chargearea" v-model="M_TN_LOOAddendum.chargearea"  ref="ref_chargearea" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_totalarealot" v-model="M_TN_LOOAddendum.totalarealot"  ref="ref_totalarealot" />
                      </b-col>
                    </b-row>
                    <b-row>
                      <b-col  md="12">
                        <ABSinputTextVuex :prop="PI_baserentalrate" v-model="M_TN_LOOAddendum.baserentalrate"  ref="ref_baserentalrate" />
                      </b-col>
                    </b-row>
                </b-col>
                <b-col md="6" id="col-right">
                  <b-row>
                    <b-col md="12">
                        <ABSCompute :prop="PI_status" v-model="M_TN_LOOAddendum.status"  ref="ref_status" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_telephoneline" v-model="M_TN_LOOAddendum.telephoneline"  ref="ref_telephoneline"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_securitydepositrental" v-model="M_TN_LOOAddendum.securitydepositrental"  ref="ref_securitydepositrental"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_securitydepositsc" v-model="M_TN_LOOAddendum.securitydepositsc"  ref="ref_securitydepositsc"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_servicecharge" v-model="M_TN_LOOAddendum.servicecharge"  ref="ref_servicecharge"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_promotionlevy" v-model="M_TN_LOOAddendum.promotionlevy"  ref="ref_promotionlevy"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_telephonedeposit" v-model="M_TN_LOOAddendum.telephonedeposit"  ref="ref_telephonedeposit"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_fitoutdeposit" v-model="M_TN_LOOAddendum.fitoutdeposit"  ref="ref_fitoutdeposit"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_sinkingfund" v-model="M_TN_LOOAddendum.sinkingfund"  ref="ref_sinkingfund"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputRadioButtonVuex @input="OnrentalbaseChange" :prop="PI_rentalbase" v-model="M_TN_LOOAddendum.rentalbase"  ref="ref_rentalbase" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputRadioButtonVuex @input="OnrevenuesharetypeChange" :prop="PI_revenuesharetype" v-model="M_TN_LOOAddendum.revenuesharetype"  ref="ref_revenuesharetype" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_renewalperiod" v-model="M_TN_LOOAddendum.renewalperiod"  ref="ref_renewalperiod"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_rentalratetype" v-model="M_TN_LOOAddendum.rentalratetype"  ref="ref_rentalratetype" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_marketingid" v-model="M_TN_LOOAddendum.marketingid"  ref="ref_marketingid" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputTextVuex :prop="PI_fitoutpic" v-model="M_TN_LOOAddendum.fitoutpic"  ref="ref_fitoutpic"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <b-row>
                        <b-col md="4" class="lbl-col-align">
                            <label :class="inputStatus=='VIEW' ? 'lbl-view-form' : 'text-field-form'" for="">Fit Out Comm. Date</label>
                        </b-col>
                        <b-col md="3" style="margin-left: 10px;">
                            <ABSTextBoxOnly :prop="PI_fitoutcommencedon" v-model="M_TN_LOOAddendum.fitoutcommencedon"  ref="ref_fitoutcommencedon"/>    
                        </b-col>
                        <b-col md="1">
                            <label :class="inputStatus=='VIEW' ? 'lbl-view-form' : 'text-field-form'" for="">Duration </label>
                        </b-col>  
                        <b-col md="1" style="padding-left: 20px !important;">
                            <ABSTextBoxOnly :prop="PI_freerentalperiod" v-model="M_TN_LOOAddendum.freerentalperiod"  ref="ref_freerentalperiod"/>                                            
                        </b-col>
                        <b-col md="1">
                            <label :class="inputStatus=='VIEW' ? 'lbl-view-form' : 'text-field-form'" for="">day(s)</label>
                        </b-col>  
                        </b-row>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSinputDateVuex @input="OnhandoverdateChange" :prop="PI_handoverdate" v-model="M_TN_LOOAddendum.handoverdate"  ref="ref_handoverdate" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSInputTimeRange :prop="PI_operatingfromhour" :valueFrom="M_TN_LOOAddendum.operatingfromhour" :valueTo="M_TN_LOOAddendum.operatingtohour" ref="ref_operatingfromhour" @from="MdtRange_operatingfromhour" @to="MdtRange_operatingtohour" />
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSInputSelectList @change="OnmediacdChange" :prop="PI_mediacd" :value="M_TN_LOOAddendum.mediacd" :label="M_TN_LOOAddendum.mediacdLabel" ref="ref_mediacd"/>
                    </b-col>
                  </b-row>
                  <b-row>
                    <b-col md="12">
                        <ABSTextAreaVuex @input="OnremarksChange" :prop="PI_remarks" v-model="M_TN_LOOAddendum.remarks"  ref="ref_remarks" />
                    </b-col>
                  </b-row>
                </b-col>
							</b-row>
...
export default {
    ...
    data() {
		...
		Module:"TN",
            propList: {
                initialWhere: "CustomerType = 'L' AND AddendumSequenceNo <> 0 AND ContractStatus IN ('1','2','3','4') AND SubPortfolioCd ='" + this.getDataUser().SubPortfolioCd +"' AND StatusCd = 'N'",
            ...
            PI_rentalbase: { 
                ...
                cName: 'rentalbase', 
                cId: 'rdbrentalbase', 
                cRadioOptions: [{ text: 'Full Rental', value: 'R' },{ text: 'Revenue Share', value: 'S' },{ text: 'Combine', value: 'C' },], 
                cRadioDefaultOption: '', 
                cLabel:'Rental Base', 
                cLabelSize: 4, 
                cOrder: 0, 
            ...
            PI_revenuesharetype: { 
                ...
                cRadioOptions: [{ text: 'Staggered', value: 'S' },{ text: 'Range Scale', value: 'R' },], 
                cRadioDefaultOption: '', 
    ...
    methods: {
        ...
        var year = dt.getFullYear()
          ...
          this.FnDynamicFunction(param)
            .then(ress => {
              ...
              this.M_TN_LOOAddendum.servicecharge = this.isCurrency(data.ServiceCharge, this.decimal)
              this.M_TN_LOOAddendum.promotionlevy = this.isCurrency(data.PromotionLevy, this.decimal)
              this.M_TN_LOOAddendum.telephonedeposit = this.isCurrency(data.TelephoneDeposit, this.decimal)
              this.M_TN_LOOAddendum.fitoutdeposit = this.isCurrency(data.FitOutDeposit, this.decimal)
              this.M_TN_LOOAddendum.sinkingfund = this.isCurrency(data.SinkingFund, this.decimal)

              this.M_TN_LOOAddendum.securitydepositrental = data.SecurityDepositRental
              ...
              switch (this.M_TN_LOOAddendum.chargeperiod) {
                  case "months":
                    ...
                    // }
                    this.M_TN_LOOAddendum.red = this.dateAdd2('D',this.dateAdd2('M',this.M_TN_LOOAddendum.rcd,this.M_TN_LOOAddendum.leaseperiod),-1)
                    break;
                  case "days":
                    this.M_TN_LOOAddendum.red = this.dateAdd2('D',this.M_TN_LOOAddendum.rcd,this.M_TN_LOOAddendum.leaseperiod)
                    break;
                  case "years":
                    this.M_TN_LOOAddendum.red = this.dateAdd2('D',this.dateAdd2('Y',this.M_TN_LOOAddendum.rcd,this.M_TN_LOOAddendum.leaseperiod),-1)
                    break;
                }
      ...
      GetContract(ApplicationNo){
          ...
          this.FnDynamicFunction(param)
            .then(ress => {
              ...
              // console.log(data)
                ...
                this.M_TN_LOOAddendum.customercategorydescs = data.CustomerCategoryDescs
                ...
                if(this.dataSpec.ContractStatus == "" || this.dataSpec.AmortizeStartAt == ""){
                  this.PI_rcd.cProtect = true
                }else{
                  if(this.dataSpec.AmortizeStartAt == "O" && this.dataSpec.ContractStatus < 2){
                    this.PI_rcd.cProtect = false
                  }else if(this.dataSpec.AmortizeStartAt == "I" && this.dataSpec.ContractStatus < 3){
                    this.PI_rcd.cProtect = false
                  }else if(this.dataSpec.AmortizeStartAt == "A" && this.dataSpec.ContractStatus < 4){
                    this.PI_rcd.cProtect = false
                  }else{
                    this.PI_rcd.cProtect = true
                  }
                ...
                this.M_TN_LOOAddendum.totalrental = this.isCurrency(data.ContractAmt, this.decimal)
                ...
                this.M_TN_LOOAddendum.totalarealot = this.isCurrency(data.TotalGrossArea, this.decimal) +' / '+ this.isCurrency(data.TotalSemiGrossArea, this.decimal) +' / '+ this.isCurrency(data.TotalNetArea, this.decimal)
              ...
              this.M_TN_LOOAddendum.copyfromapplicationnoLabel = this.M_TN_LOOAddendum.copyfromapplicationno != null && this.M_TN_LOOAddendum.copyfromapplicationno != '' ? data.ApplicationNo + this.separator  + data.LOONo :'' 
              this.M_TN_LOOAddendum.brandcdLabel = this.M_TN_LOOAddendum.brandcd != null && this.M_TN_LOOAddendum.brandcd != '' ? data.BrandCd + this.separator + data.BrandName  :'' 
              ...
              this.M_TN_LOOAddendum.mediacdLabel = this.M_TN_LOOAddendum.mediacd != null && this.M_TN_LOOAddendum.mediacd != '' ? data.MediaCd + this.separator  :'' 
        ...
        SetLookUpBrand(){
          if(this.M_TN_LOOAddendum.contactid != '' && this.M_TN_LOOAddendum.contactid !=null){
...
// alert(this.M_TN_LOOAddendum.contactid)
          ...
          this.FnDynamicFunction(param)
            .then(ress => {
                if (ress.length > 0) {
                  this.PI_brandcd.dataLookUp .InitialWhere += "AND (BrandOwnerId = '" + this.M_TN_LOOAddendum.contactid + "' OR  ISNULL(BrandOwnerId,'')='')"
                }
            })
...
//{chargearea}
        ...
        M_Insert() {         
          ...
          if (this.M_TN_LOOAddendum.addendumrefno == "(auto)") { 
            ...
            var param = {			
                ...
                LineNo: this.$parent.data.PageOrder,
                SubPortfolioCd: this.getDataUser().SubPortfolioCd,
                ApplicationNo: this.M_TN_LOOAddendum.applicationno == '' || this.M_TN_LOOAddendum.applicationno == null ? 'NULL' : this.M_TN_LOOAddendum.applicationno ,
                LOONo: this.M_TN_LOOAddendum.loono,
                LOODate: this.M_TN_LOOAddendum.loodate == '' || this.M_TN_LOOAddendum.loodate == null ? 'NULL' : this.M_TN_LOOAddendum.loodate ,
                CopyFromApplicationNo: this.M_TN_LOOAddendum.copyfromapplicationno,
                AddendumRefNo: this.M_TN_LOOAddendum.addendumrefno,
                AddendumDate: this.M_TN_LOOAddendum.addendumdate == '' || this.M_TN_LOOAddendum.addendumdate == null ? 'NULL' : this.M_TN_LOOAddendum.addendumdate ,
                AddendumTypeCd: this.M_TN_LOOAddendum.addendumtypecd == '' || this.M_TN_LOOAddendum.addendumtypecd == null ? 'NULL' : this.M_TN_LOOAddendum.addendumtypecd ,
                ...
                BrandCd: this.M_TN_LOOAddendum.brandcd == '' || this.M_TN_LOOAddendum.brandcd == null ? 'NULL' : this.M_TN_LOOAddendum.brandcd ,
                BrandName: this.M_TN_LOOAddendum.brandname,
                StartDate: this.M_TN_LOOAddendum.startdate == '' || this.M_TN_LOOAddendum.startdate == null ? 'NULL' : this.M_TN_LOOAddendum.startdate ,
                EndDate: this.M_TN_LOOAddendum.enddate,
                LeasePeriod: this.M_TN_LOOAddendum.leaseperiod,
                FreeRentalPeriod: this.M_TN_LOOAddendum.freerentalperiod,
                RCD: this.M_TN_LOOAddendum.rcd == '' || this.M_TN_LOOAddendum.rcd == null ? 'NULL' : this.M_TN_LOOAddendum.rcd ,
                RED: this.M_TN_LOOAddendum.red == '' || this.M_TN_LOOAddendum.red == null ? 'NULL' : this.M_TN_LOOAddendum.red ,
                UtilitiesStartDate: this.M_TN_LOOAddendum.utilitiesstartdate == '' || this.M_TN_LOOAddendum.utilitiesstartdate == null ? 'NULL' : this.M_TN_LOOAddendum.utilitiesstartdate ,
                UtilitiesEndDate: this.M_TN_LOOAddendum.utilitiesenddate == '' || this.M_TN_LOOAddendum.utilitiesenddate == null ? 'NULL' : this.M_TN_LOOAddendum.utilitiesenddate ,
                ...
                FitOutCommencedOn: this.M_TN_LOOAddendum.fitoutcommencedon == '' || this.M_TN_LOOAddendum.fitoutcommencedon == null ? 'NULL' : this.M_TN_LOOAddendum.fitoutcommencedon ,
                FitOutTime: this.M_TN_LOOAddendum.fitouttime,
                FitOutPIC: this.M_TN_LOOAddendum.fitoutpic,
                HandOverDate: this.M_TN_LOOAddendum.handoverdate == '' || this.M_TN_LOOAddendum.handoverdate == null ? 'NULL' : this.M_TN_LOOAddendum.handoverdate ,
                OperatingFromHour: this.M_TN_LOOAddendum.operatingfromhour,
                OperatingToHour: this.M_TN_LOOAddendum.operatingtohour,
                MediaCd: this.M_TN_LOOAddendum.mediacd == '' || this.M_TN_LOOAddendum.mediacd == null ? 'NULL' : this.M_TN_LOOAddendum.mediacd ,
                ServiceCharge: this.M_TN_LOOAddendum.servicecharge ? this.replaceAllString(this.M_TN_LOOAddendum.servicecharge,',','','number') : 0 ,
                PromotionLevy: this.M_TN_LOOAddendum.promotionlevy ? this.replaceAllString(this.M_TN_LOOAddendum.promotionlevy,',','','number') : 0 ,
                TelephoneDeposit: this.M_TN_LOOAddendum.telephonedeposit ? this.replaceAllString(this.M_TN_LOOAddendum.telephonedeposit,',','','number') : 0 ,
                FitOutDeposit: this.M_TN_LOOAddendum.fitoutdeposit ? this.replaceAllString(this.M_TN_LOOAddendum.fitoutdeposit,',','','number') : 0 ,
                SinkingFund: this.M_TN_LOOAddendum.sinkingfund ? this.replaceAllString(this.M_TN_LOOAddendum.sinkingfund,',','','number') : 0 ,
        ...
        M_New(){
          ...
          if (this.M_TN_LOOAddendum.addendumrunningcd != null && this.M_TN_LOOAddendum.addendumrunningcd != "") { 
            this.M_TN_LOOAddendum.addendumrefno = "(auto)"
            this.PI_addendumrefno.cProtect = true 
          } else {
            this.M_TN_LOOAddendum.addendumrefno = ""
...
this.M_TN_LOOAddendum = {
                ...
                contactidLabel: (data.contactid && data.contactid != '' ? data.contactid + this.separator + data.customername : ''),
                ...
                currencycdLabel: (data.currencycd && data.currencycd != '' ? data.currencycd + this.separator + data.currencydescs : ''),
                ...
                this.M_TN_LOOAddendum.applicationnoLabel = this.M_TN_LOOAddendum.applicationno != null && this.M_TN_LOOAddendum.applicationno != '' ? data.applicationno + this.separator + data.loono :'' 
                this.M_TN_LOOAddendum.addendumtypecdLabel = this.M_TN_LOOAddendum.addendumtypecd != null && this.M_TN_LOOAddendum.addendumtypecd != '' ? data.addendumtypecd + this.separator + data.addendumtypedescs :'' 
                this.M_TN_LOOAddendum.brandcdLabel = this.M_TN_LOOAddendum.brandcd != null && this.M_TN_LOOAddendum.brandcd != '' ? data.brandcd + this.separator + data.brandname :'' 
                this.M_TN_LOOAddendum.mediacdLabel = this.M_TN_LOOAddendum.mediacd != null && this.M_TN_LOOAddendum.mediacd != '' ? data.mediacd + this.separator + data.mediadescs :'' 
