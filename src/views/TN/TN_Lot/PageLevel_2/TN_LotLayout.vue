						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                <b-col md="12" id="col-left"> <!-- table open -->
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSinputTextVuex :prop="PI_descs" v-model="M_TN_LotLayout.descs"  ref="ref_descs"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSTextAreaVuex @input="OnremarksChange" :prop="PI_remarks" v-model="M_TN_LotLayout.remarks"  ref="ref_remarks" />
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col  md="6">
                                        <ABSFileUpload :prop="PI_referencefilename" @fileName="getFileName" 
                                                                        v-model="M_TN_LotLayout.referencefilename" 
                                                                        :file="M_TN_LotLayout.picturefilename" 
                                                                        :image="M_TN_LotLayout.referencefilename"
...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_TN_LotLayout.lotno = data.LotNo 
        ...
        M_Insert() {
            var param = {
                ...
                LineNo: this.$parent.data.PageOrder,
                SubPortfolioCD: this.getDataUser().SubPortfolioCd,
                LotNo: this.M_TN_LotLayout.lotno,
                Descs: this.M_TN_LotLayout.descs,
                PictureFileName: this.M_TN_LotLayout.picturefilename,
                ReferenceFileName: this.M_TN_LotLayout.referencefilename,
                Remarks: this.M_TN_LotLayout.remarks,
        ...
        M_Update() {
            var param = {
                ...
                SubPortfolioCD: this.getDataUser().SubPortfolioCd,
                LotNo: this.M_TN_LotLayout.lotno,
                SequenceNo: this.M_TN_LotLayout.sequenceno,
                Descs: this.M_TN_LotLayout.descs,
                PictureFileName: this.M_TN_LotLayout.picturefilename,
                ReferenceFileName: this.M_TN_LotLayout.referencefilename,
                Remarks: this.M_TN_LotLayout.remarks,
                UserEdit: this.getDataUser().UserId ,
                LastUpdateStamp: this.M_TN_LotLayout.lastupdatestamp
            }
...
this.M_TN_LotLayout = {
        ...
        ,getFileName(fileName) {
         this.M_TN_LotLayout.picturefilename = fileName 
        }
