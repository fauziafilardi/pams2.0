...
//{remarks}
        ...
        M_Insert() {
            var param = {
                ...
                LOIStatus: this.M_TN_LotAuthorizedUser.processstatus.indexOf('I') > -1 ? "Y" : "N",
...
this.M_TN_LotAuthorizedUser = {
                ...
                if (data.loistatus && data.loistatus != '' && data.loistatus == "Y") this.M_TN_LotAuthorizedUser.processstatus.push("I")
