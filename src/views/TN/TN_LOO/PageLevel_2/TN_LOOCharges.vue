						...
						<b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                            <b-row style="padding-left:10px;">					
                                ...
                                <b-col md="6" id="col-right"> <!-- table open right -->
                                    ...
                                    <b-row>
                                      <b-col md="12">
                                        <ABSinputTextVuex @input="OnbillingintervalChange" :prop="PI_billinginterval" v-model="M_TN_LOOCharges.billinginterval"  ref="ref_billinginterval"/>
                                      </b-col>
                                    </b-row>
                                    <b-row>
                                      <b-col md="12">
    ...
    methods: {
      ...
      SetEditableBillingControl(from){
        ...
        if(this.M_TN_LOOCharges.installmentmethod=='N'){
            ...
            switch(this.M_TN_LOOCharges.chargebasis){
              ...
              case "A":
                  ...
                  this.PI_billingamt.cProtect = true
                  //this.M_TN_LOOCharges.amortizemonthlyamt = '' request destri 09/03/2020
        ...
        GetLeasingPolicyRentalDataDefault(){
            ...
            this.FnDynamicFunction(param)
                .then(ress => {
                  ...
                  this.M_TN_LOOCharges.contractamt = data.ContractAmt
                  var ctramt = this.isCurrency(data.ContractAmt, this.decimal)
                  ...
                  this.FnDynamicFunction(param2)
                    .then(ress => {
                      ...
                      if(parseInt(this.M_TN_LOOCharges.billingfrequency)==0){
                          ...
                          this.M_TN_LOOCharges.billingamt = this.isCurrency((ctramt * this.M_TN_LOOCharges.billingpercent)/100/this.M_TN_LOOCharges.BillingFrequency, this.decimal)
                      }
        ...
        RecalculateBillingAmt(check = ''){
          // console.log(this.M_TN_LOOCharges.chargebasis);
          if(this.M_TN_LOOCharges.chargebasis == 'A'){
              //var billRate = this.M_TN_LOOCharges.billingrate == '' || this.M_TN_LOOCharges.billingrate == null ? 0 : parseFloat(this.M_TN_LOOCharges.billingrate)
              var billRate = this.M_TN_LOOCharges.billingrate == '' || this.M_TN_LOOCharges.billingrate == null ? 0 : parseFloat(this.replaceAllString(this.M_TN_LOOCharges.billingrate,',','','number'))
              var ttlArea = this.M_TN_LOOCharges.totalarea == '' || this.M_TN_LOOCharges.totalarea == null ? 0 : parseFloat(this.replaceAllString(this.M_TN_LOOCharges.totalarea,',','','number'))
              var billinterval = this.M_TN_LOOCharges.billinginterval == '' || this.M_TN_LOOCharges.billinginterval == null ? 0 : parseInt(this.M_TN_LOOCharges.billinginterval)

              if(this.M_TN_LOOCharges.installmentmethod == 'N'){
                this.M_TN_LOOCharges.amortizemonthlyamt = this.isCurrency((billRate*ttlArea), this.decimal)
              }
              
              this.M_TN_LOOCharges.billingamt = this.isCurrency((billRate*ttlArea*billinterval), this.decimal)
          }
            ...
            if (this.inputStatus != "VIEW") {
              var param = {
                ...
                .then(ress => {
                  ...
                  this.M_TN_LOOCharges.billingmethod = dataMap.AmortizeMethod
        ...
        this.$nextTick(() => {
            if(this.inputStatus != "VIEW") {
              ...
              if(this.M_TN_LOOCharges.chargebasis=='A'){
                ...
                this.M_TN_LOOCharges.billingrate = ''
                //this.M_TN_LOOCharges.billingmethod = 'F' remark destri 09/03/2020
        ...
        M_Update() {
          ...
          this.FnDynamicFunction(param)
              .then(ress => {
                ...
                this.M_TN_LOOCharges.totalpercent = parseInt(TotPercent)
                if (vTotalBilling > 100 ){
                  this.PI_billingpercent.cValidate = 'max_value:' + this.M_TN_LOOCharges.totalpercent + '|cmax_value:Total Billing Percent must be less than or equal 100. Please set with ' + this.M_TN_LOOCharges.totalpercent + '|required'
                  this.$validator._base.validateAll(scopeForm)
                }
                else{
                  this.M_UpdateOR()
