          ...
          <b-col sm="12">
            ...
            <div class="modal-customize-abs__modal-body">
              ...
              <ABSButton
                ...
                @click="updateCoordinateProperty"
                :disabled="propertyChoosed == null"
              />
              <br />
            </div>
          </b-col>
    ...
    <vl-map ref="map"
      ...
      <vl-layer-vector ref="vectorLayer" id="my-features">
        <vl-source-vector ref="vectorSource">
          <vl-feature v-for="feature in propertyList"
                      :key="feature.id"
                      :id="feature.id"
  ...
  export default {
    watch: {
      ...
      selectedFeatures: function(newData, oldData) {
        ...
        if (this.selectedFeatures.length > 0) {
          ...
          var desc = ''
          var x
          for (x = 0 ; x < this.propertyList.length ; x ++) {
            if (newData[0].id == this.propertyList[x].id) {
              desc = this.propertyList[x].Descs
              break
            }
          }
          this.$parent.$parent.masterPlanChoosed = 'Pro'+ this.propertyList[x].id
          ...
          //       PropertyId: newData[0].id,
          //       Coordinate: 'NULL',
          //       Remarks: '',
          //       UserId: this.getDataUser().UserId
          //     }
          //     this.postEncode(this.getUrlUpdateCoordinateProperty(), param)
          //     .then((response) => {
    ...
    methods: {
      ...
      getProperty () {
        ...
        this.postEncode(this.getUrlGetCoordinateProperty(), param)
        .then((response) => {
          if (response == null) return
      ...
      updateCoordinateProperty () {
        ...
        var param = {
          SubPortfolioCd: this.subPortfolioCode,
          PropertyId: this.propertyChoosed,
