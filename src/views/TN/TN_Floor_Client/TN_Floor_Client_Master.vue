            ...
            <b-col md="12" id="col-left" class="bColMasterForm">	
              <!-- <b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex"> -->
                <b-row style="margin-bottom: 20px;">
                  <b-col md="12">
                    <label class="text-field-form" style="font-size: 1rem !important; color: #215B7D !important;"><strong> Floor Plan </strong></label>
                  </b-col>
                </b-row>
                <b-row>
                  <b-col md="1" style="margin-left: 10px;">
                    <b-button size="sm" variant="primary" @click="moveToLeft" :disabled="isMoveToLeft">
                      Back
                        <!-- &lt; -->
                    </b-button>
                    <!-- <b-button size="sm" variant="primary" @click="moveToRight" :disabled="isMoveToRight">
                        &gt;
                    </b-button> -->
                  </b-col>
                </b-row>
                <br />
                <b-row v-if="subportfolioLabel!=''">
                  <b-col md="1" style="margin-left: 10px;">
                    Subportfolio
                  </b-col>
                  <b-col>
...
<script>
import GoogleMap from '@/views/TN/TN_Floor_Client/TN_FloorGoogleMap'
import SubPortfolio from '@/views/TN/TN_Floor_Client/TN_FloorSubPortfolio'
import Property from '@/views/TN/TN_Floor_Client/TN_FloorProperty'
import Zone from '@/views/TN/TN_Floor_Client/TN_FloorZone'
import FloorPlan from '@/views/TN/TN_Floor_Client/TN_FloorPlan'
      ...
      for (var x = 0 ; x < list.length ; x ++) {
        if (list[x].id == this.masterPlanChoosed) {
          ...
          if (list[x].hasOwnProperty('FloorPlanId')) {
            ...
            this.floorPlan = list[x].FloorPlanId
            this.floorPlanLabel = this.masterPlanChoosedLabel
            ...
            this.zone = list[x].ZoneId
            this.zoneLabel = this.masterPlanChoosedLabel
            // this.floorPlan = ''
            ...
            this.property = list[x].PropertyId
            this.propertyLabel = this.masterPlanChoosedLabel
            // this.zone = ''
            // this.floorPlan = ''
            ...
            this.subportfolio = list[x].SubPortfoliocd
            this.subportfolioLabel = this.masterPlanChoosedLabel
            // this.property = ''
            // this.zone = ''
            // this.floorPlan = ''
