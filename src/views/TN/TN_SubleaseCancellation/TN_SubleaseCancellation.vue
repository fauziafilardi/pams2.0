...
export default {
    data() {
        return {
            propList: {
                initialWhere: "ProcessControlSequenceNo IS NULL AND Status = 'N' And SubleaseAssignmentType = 'S' AND SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "'",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    ...
                    SubleaseNo : value.SubleaseAssignmentNo,
                    ReasonCd: reasoncode,
                    ReasonDescs: reasoncodedescs,
                    UserEdit: this.getDataUser().UserId,
                    _Message_: "Sublease No " + value.SubleaseAssignmentNo + " Cancelled "
                })
            })
