...
export default {
    data() {
        return {
            propList: {
                initialWhere: "CustomerType = 'C' AND [Status] = 'N' AND SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "' AND (UserID IS NULL OR (UserId='" + this.getDataUser().UserId + "' AND LOOStatus = 'Y'))",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
