...
export default {
    data() {
        return {
            propList: {
                initialWhere: "Status = 'N' AND SubPortfolioCd='" + this.getDataUser().SubPortfolioCd + "' AND ((Antenna = 'Y') or (Antenna = 'N' and CntBudgetRental >= 1))",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                dataPost.push({
                    ...
                    _Message_ : 'Leasing Budget Entry ' + value.BudgetYear
                })
            })
