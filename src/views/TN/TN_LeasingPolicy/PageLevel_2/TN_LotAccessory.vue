...
//{remarks}
        ...
        M_Insert() {
            var param = {			
                ...
                Qty: this.M_TN_LotAccessory.qty,
...
this.M_TN_LotAccessory = {
                ...
                this.M_TN_LotAccessory.accessorycdLabel = this.M_TN_LotAccessory.accessorycd != null && this.M_TN_LotAccessory.accessorycd != '' ? data.accessorycd + this.separator  :'' 
