...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_CM_ContactAddressAssign.debtorcd = data.DebtorCd 
            this.propList.initialWhere =" ContactId = '" + data.ContactID + "' And SubportfoliCd = '"+this.getDataUser().SubPortfolioCd+"'"
