                            ...
                            <b-form :data-vv-scope="'FormScope_' + PageLevel + '_' + TabIndex" :data-vv-value-path="'FormScope_' + PageLevel + '_' + TabIndex">
                                <b-row style="padding-left:10px;">
                                    <b-col md="12" id="col-left">
                                        <b-row>
                                            <b-col md=4>
                                                <ABSinputDateVuex :prop="PI_PenaltyDate" v-model="PenaltyDate"/>
                                            </b-col>
                                        </b-row>                                        
                                    </b-col>
                                </b-row>
...
export default {
    data() {
        return {
            propList: {
                initialWhere: "SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "' AND Penalty ='Y'",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
    ...
    methods: {        
       ...
       M_ClearForm(){
        ...
        M_Post() {
            ...
            var PenaltyDate = this.PenaltyDate == '' || this.PenaltyDate == null ? 'NULL' : this.PenaltyDate
