...
<script>
import MyModal from'./AR_viewModal.vue'
export default {
        ...
        doGenerate() {
            ...
            if(this.M_AR_RevaluationInquiry.debtorcdfrom != ''){
                if(this.M_AR_RevaluationInquiry.debtorcdto != ''){
                    this.propList.initialWhere += " AND DebtorCd BETWEEN '" + this.M_AR_RevaluationInquiry.debtorcdfrom + "' AND '" + this.M_AR_RevaluationInquiry.debtorcdto + "'"     
                } else {
                    this.propList.initialWhere += " AND DebtorCd ='"+ this.M_AR_RevaluationInquiry.debtorcdfrom +"'"
                }                
            }
            ...
            if(this.M_AR_RevaluationInquiry.debitdatefrom != ''){
                if(this.M_AR_RevaluationInquiry.debitdateto != ''){
                    this.propList.initialWhere += " AND DebtorCd BETWEEN '" + this.M_AR_RevaluationInquiry.debitdatefrom + "' AND '" + this.M_AR_RevaluationInquiry.debitdateto + "'"     
                } else {
                    this.propList.initialWhere += " AND DebtorCd ='"+ this.M_AR_RevaluationInquiry.debitdatefrom +"'"
                }                
            }
            ...
            if(this.M_AR_RevaluationInquiry.currencycdfrom != ''){
                if(this.M_AR_RevaluationInquiry.currencycdto != ''){
                    this.propList.initialWhere += " AND DebtorCd BETWEEN '" + this.M_AR_RevaluationInquiry.currencycdfrom + "' AND '" + this.M_AR_RevaluationInquiry.currencycdto + "'"     
                } else {
                    this.propList.initialWhere += " AND DebtorCd ='"+ this.M_AR_RevaluationInquiry.currencycdfrom +"'"
                }                
            }            
