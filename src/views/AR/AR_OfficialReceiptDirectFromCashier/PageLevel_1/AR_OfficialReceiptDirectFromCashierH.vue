    ...
    getDataBy(record) {
      ...
      this.postEncode(url, param).then(response => {
        ...
        this.M_AR_OfficialReceiptDirectFromCashierH = {
          ...
          descs: data.descs,
          paymentcd: data.paymentcd + this.separator + data.paymentdescs,
          currencycd: data.currencycd + this.separator + data.currencydescs,
          bankcd: data.bankcd + this.separator + data.bankname,
          chequereferenceno: data.chequereferenceno,
          currencyrate: this.isCurrency(data.currencyrate, this.decimal),
          chequereferencedate: this.momentDateFormatting(new Date(data.chequereferencedate), 'DD/MM/YYYY'),
          issuedbank: data.issuedbank,
          chequeduedate: this.momentDateFormatting(new Date(data.chequeduedate), 'DD/MM/YYYY'),
