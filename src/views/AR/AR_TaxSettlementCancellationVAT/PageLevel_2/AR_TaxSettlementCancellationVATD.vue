...
export default {
    ...
    data() {
		...
		Module:"AR",
            ...
            M_AR_TaxSettlementCancellationVATD :{
...
//{remarks}
		...
		paramFromParent(){
            ...
            this.M_AR_TaxSettlementCancellationVATD.taxsettlementcancellationno = data.TaxSettlementCancellationNo
            this.propList.ParamView = "'" + this.getDataUser().SubPortfolioCd + "', '" + data.TaxSettlementCancellationNo + "', 'V'"
        ...
        M_Insert() {
            ...
            .then((response) => {
                ...
                var msg = "Data Hass Been Save Successfully"
            ...
            //     TaxSettlementType: this.M_AR_TaxSettlementCancellationVATH.taxsettlementtype,
            //     Status: this.M_AR_TaxSettlementCancellationVATH.status,
