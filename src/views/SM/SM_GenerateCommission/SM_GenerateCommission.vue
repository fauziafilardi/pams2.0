...
export default {
    data() {
        return {
            propList: {
                initialWhere: "SubPortfolioCd = '" + this.getDataUser().SubPortfolioCd + "' AND CommisionStatus='N'",
                LineNo: 0,
                PageLevel: 1,
                TabIndex: 1
            },
        ...
        M_Post() {
            ...
            data.forEach((value) => {
                ...
                dataPost.push({
                    ...
                    GenerateDate : postingdate,
                    OrderNo: value.OrderNo,
                    ModuleCd: this.Module,
                    UserID: this.getDataUser().UserId,
                    // LastUpdateStamp: value.LastUpdateStamp,
                    _Message_: "Commission for Order No " + value.OrderNo
                })
            })
